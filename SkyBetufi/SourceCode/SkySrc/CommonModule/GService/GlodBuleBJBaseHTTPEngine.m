...
@interface GlodBuleBJBaseHTTPEngine ()
@property (nonatomic, strong) AFHTTPSessionManager *sessionManager;
@end
@implementation GlodBuleBJBaseHTTPEngine
...
- (void)tao_updateSessionWithBlock:(void(^)(AFHTTPSessionManager *sesson))updateBlock {
...
- (void)tao_imageUploadWithFunctionPath:(NSString *)functionPath
                      ...
                      progressBlock:(BJHTTPProgressBlock)progressBlock
                       successBlock:(BJHTTPSuccessBlock)successBlock
                         errorBlock:(BJHTTPFailureBlock)errorBlock {
    [self tao_fileUploadWithFunctionPath:functionPath params:params fileData:imageData fileName:imageName mimeType:@"image/jpeg" progressBlock:progressBlock successBlock:successBlock errorBlock:errorBlock];
}
@end
