...
@interface PXFunBJWebViewController ()
...
@property (nonatomic, strong) CCCaseBJWebViewJSBridge *jsBridge;
...
@end
@implementation PXFunBJWebViewController
...
- (void)setupJSBridge {
    self.jsBridge = [[CCCaseBJWebViewJSBridge alloc] initWithWebView:self.webView viewController:self];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([navigationAction.request.URL.scheme isEqualToString:BJURIScheme]) {
        BOOL result = [[YYPackageBJURINavigator sharedInstance] handleURI:url];
        if (result) {
