...
@interface YYPackageBJURINavigator ()
@property (nonatomic, strong) NSMutableDictionary *uriHandlerDict;
@end
@implementation YYPackageBJURINavigator
+ (instancetype)sharedInstance {
    static YYPackageBJURINavigator *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YYPackageBJURINavigator alloc] init];
