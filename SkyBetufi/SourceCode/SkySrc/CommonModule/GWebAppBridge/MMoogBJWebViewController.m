...
@interface MMoogBJWebViewController ()
...
@property (nonatomic, strong) NSNiceBJWebViewJSBridge *jsBridge;
...
@end
@implementation MMoogBJWebViewController
...
- (void)setupJSBridge {
    self.jsBridge = [[NSNiceBJWebViewJSBridge alloc] initWithWebView:self.webView viewController:self];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([navigationAction.request.URL.scheme isEqualToString:BJURIScheme]) {
        BOOL result = [[YeYeeBJURINavigator sharedInstance] handleURI:url];
        if (result) {
