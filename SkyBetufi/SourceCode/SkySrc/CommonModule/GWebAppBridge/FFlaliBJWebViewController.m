...
@interface FFlaliBJWebViewController ()
...
@property (nonatomic, strong) CfipyBJWebViewJSBridge *jsBridge;
...
@end
@implementation FFlaliBJWebViewController
...
- (void)setupJSBridge {
    self.jsBridge = [[CfipyBJWebViewJSBridge alloc] initWithWebView:self.webView viewController:self];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([navigationAction.request.URL.scheme isEqualToString:BJURIScheme]) {
        BOOL result = [[UUaksBJURINavigator sharedInstance] handleURI:url];
        if (result) {
