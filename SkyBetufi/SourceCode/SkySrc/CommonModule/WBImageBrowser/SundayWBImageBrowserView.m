...
#import "NDeskWBImageBrowserCell.h"
...
@interface SundayWBImageBrowserView () <UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation SundayWBImageBrowserView
...
+ (instancetype)pictureBrowsweViewWithFrame:(CGRect)frame delegate:(id<WBImageBrowserViewDelegate>)delegate browserInfoArray:(NSArray *)browserInfoArray {
    SundayWBImageBrowserView *pictureBrowserView = [[self alloc] initWithFrame:frame];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NDeskWBImageBrowserCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    NDeskWBImageBrowserCell *cell1 = (NDeskWBImageBrowserCell *)cell;
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[NDeskWBImageBrowserCell class] forCellWithReuseIdentifier:cellID];
...
//            [self doShareToPlatform:UMSocialPlatformType_Facebook withMessage:messageObject];
            ...
            [FBSDKShareDialog showFromViewController:[PXFunPPXXBJViewControllerCenter currentViewController]
                                          withContent:content
                                             delegate:nil];
...
//            if (weakSelf.img_url) {
//                [GGCatBJLoadingHud showHUDInView:[PXFunPPXXBJViewControllerCenter currentViewController].view];
...
//                        [weakSelf doShareToPlatform:UMSocialPlatformType_Line withMessage:messageObject];
//                    }
//                    [GGCatBJLoadingHud hideHUDInView:[PXFunPPXXBJViewControllerCenter currentViewController].view];
//                }];
//            } else {
//                [weakSelf doShareToPlatform:UMSocialPlatformType_Line withMessage:messageObject];
//            }
