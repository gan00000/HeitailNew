//
//  TuTuosHTImageBrowserViewController.m
//  SkyBallPlay
//
...
@interface TuTuosHTImageBrowserViewController ()<WBImageBrowserViewDelegate>
{
    YeYeeWBImageBrowserView *pictureBrowserView;
    NSArray  *listAM;
}

@end

@implementation TuTuosHTImageBrowserViewController
...
//    [self.view addSubview:button];
       ...
       [YeYeeWBImageBrowserView clearImagesCache];
       
       pictureBrowserView = [YeYeeWBImageBrowserView pictureBrowsweViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)
                                                                     delegate:self
