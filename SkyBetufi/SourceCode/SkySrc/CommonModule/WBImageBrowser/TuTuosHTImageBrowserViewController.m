...
{
    FFlaliWBImageBrowserView *pictureBrowserView;
    NSArray  *listAM;
}
...
//    [self.view addSubview:button];
       ...
       [FFlaliWBImageBrowserView clearImagesCache];
       
       pictureBrowserView = [FFlaliWBImageBrowserView pictureBrowsweViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)
                                                                     delegate:self
