//
//  GlodBuleHTImageBrowserViewController.m
//  SkyBallPlay
//
...
@interface GlodBuleHTImageBrowserViewController ()<WBImageBrowserViewDelegate>
{
    GlodBuleWBImageBrowserView *pictureBrowserView;
    NSArray  *listAM;
}

@end

@implementation GlodBuleHTImageBrowserViewController
...
//    [self.view addSubview:button];
       ...
       [GlodBuleWBImageBrowserView clearImagesCache];
       
       pictureBrowserView = [GlodBuleWBImageBrowserView pictureBrowsweViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)
                                                                     delegate:self
