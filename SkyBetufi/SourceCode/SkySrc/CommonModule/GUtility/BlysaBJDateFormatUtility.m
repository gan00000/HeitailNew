...
@implementation BlysaBJDateFormatUtility
...
+ (NSString *)dateToShowFromDateString:(NSString *)dateString dateFormat:(NSString *)dateFormat {
    ...
    return [BlysaBJDateFormatUtility dateToShowFromDate:[formatter dateFromString:dateString]];
}
+ (NSString *)dateToShowFromTimeInterval:(NSTimeInterval)timeInterval {
    return [BlysaBJDateFormatUtility dateToShowFromDate:[NSDate dateWithTimeIntervalSince1970:timeInterval]];
}
@end
