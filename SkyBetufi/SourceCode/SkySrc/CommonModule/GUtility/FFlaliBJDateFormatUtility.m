...
@implementation FFlaliBJDateFormatUtility
...
+ (NSString *)dateToShowFromDateString:(NSString *)dateString dateFormat:(NSString *)dateFormat {
    ...
    return [FFlaliBJDateFormatUtility dateToShowFromDate:[formatter dateFromString:dateString]];
}
+ (NSString *)dateToShowFromTimeInterval:(NSTimeInterval)timeInterval {
    return [FFlaliBJDateFormatUtility dateToShowFromDate:[NSDate dateWithTimeIntervalSince1970:timeInterval]];
}
@end
