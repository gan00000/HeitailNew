...
#import "BByasXJLoadingView.h"
#import "objc/runtime.h"
#import "Masonry.h"
static void * kLoadingViewKey;
@implementation UIView (HourseLoading)
...
- (void)showLoadingViewWithEdge:(UIEdgeInsets)edge {
    ...
    BByasXJLoadingView *loadingView = [[NSBundle mainBundle] loadNibNamed:@"BByasXJLoadingView" owner:nil options:nil].firstObject;
