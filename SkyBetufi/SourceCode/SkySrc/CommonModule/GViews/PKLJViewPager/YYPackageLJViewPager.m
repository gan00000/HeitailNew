#import "YYPackageLJViewPager.h"
#import "NDeskLJTabBar.h"
@protocol UIScrollViewDelegateAdapter <UIScrollViewDelegate>
@end
@interface YYPackageLJViewPager () <UIScrollViewDelegate>
...
@end
@implementation YYPackageLJViewPager
- (instancetype)init {
    if (self == [super init]) {
        [self setup];
    }
...
- (void)setTabBar:(NDeskLJTabBar *)tabBar {
    _tabBar = tabBar;
