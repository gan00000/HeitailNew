...
@end
@implementation GlodBuleLJViewPager
- (instancetype)init {
    if (self == [super init]) {
        [self setup];
    }
...
- (void)setTabBar:(GlodBuleLJTabBar *)tabBar {
    _tabBar = tabBar;
