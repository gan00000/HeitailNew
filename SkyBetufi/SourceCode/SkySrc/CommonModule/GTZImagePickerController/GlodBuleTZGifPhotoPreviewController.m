...
@interface GlodBuleTZGifPhotoPreviewController () {
    UIView *_toolBar;
...
@end
@implementation GlodBuleTZGifPhotoPreviewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)configBottomToolBar {
    ...
    [[GlodBuleTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
