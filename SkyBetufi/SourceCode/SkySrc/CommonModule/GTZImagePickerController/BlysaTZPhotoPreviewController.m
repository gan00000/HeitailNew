...
#import "TuTuosTZPhotoPreviewCell.h"
...
#import "FFlaliTZImageCropManager.h"
@interface BlysaTZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@end
@implementation BlysaTZPhotoPreviewController
...
- (void)viewDidLoad {
    ...
    TuTuosTZImagePickerController *_tzImagePickerVc = (TuTuosTZImagePickerController *)weakSelf.navigationController;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [NSNiceTZImageManager manager].shouldFixOrientation = NO;
}
...
- (void)configBottomToolBar {
    ...
    TuTuosTZImagePickerController *_tzImagePickerVc = (TuTuosTZImagePickerController *)self.navigationController;
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[TuTuosTZPhotoPreviewCell class] forCellWithReuseIdentifier:@"TuTuosTZPhotoPreviewCell"];
...
- (void)configCropView {
    ...
    if (!_tzImagePickerVc.showSelectBtn && _tzImagePickerVc.allowCrop) {
        ...
        [FFlaliTZImageCropManager overlayClippingWithView:_cropBgView cropRect:_tzImagePickerVc.cropRect containerView:self.view needCircleCrop:_tzImagePickerVc.needCircleCrop];
...
- (void)doneButtonClick {
    ...
    if (_tzImagePickerVc.allowCrop) { 
        ...
        TuTuosTZPhotoPreviewCell *cell = (TuTuosTZPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
        UIImage *cropedImage = [FFlaliTZImageCropManager cropImageView:cell.previewView.imageView toRect:_tzImagePickerVc.cropRect zoomScale:cell.previewView.scrollView.zoomScale containerView:self.view];
        if (_tzImagePickerVc.needCircleCrop) {
            cropedImage = [FFlaliTZImageCropManager circularClipImage:cropedImage];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TuTuosTZPhotoPreviewCell" forIndexPath:indexPath];
        TuTuosTZPhotoPreviewCell *photoPreviewCell = (TuTuosTZPhotoPreviewCell *)cell;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:[TuTuosTZPhotoPreviewCell class]]) {
        [(TuTuosTZPhotoPreviewCell *)cell recoverSubviews];
    }
}
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    if (![[NSNiceTZImageManager manager] isPhotoSelectableWithAsset:model.asset]) {
...
- (void)showPhotoBytes {
    [[NSNiceTZImageManager manager] getPhotosBytesWithArray:@[_models[_currentIndex]] completion:^(NSString *totalBytes) {
