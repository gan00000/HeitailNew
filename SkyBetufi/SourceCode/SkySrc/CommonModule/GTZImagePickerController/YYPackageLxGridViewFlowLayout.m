#import "YYPackageLxGridViewFlowLayout.h"
#import "SundayDRPhotoKeyboardCell.h"
...
@interface YYPackageLxGridViewFlowLayout () <UIGestureRecognizerDelegate>
...
@end
@implementation YYPackageLxGridViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            SundayDRPhotoKeyboardCell *sourceCell = (SundayDRPhotoKeyboardCell *)sourceCollectionViewCell;
