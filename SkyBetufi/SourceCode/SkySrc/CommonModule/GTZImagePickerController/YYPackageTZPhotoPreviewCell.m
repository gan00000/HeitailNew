...
@end
@implementation YYPackageTZPhotoPreviewCell
- (void)configSubviews {
...
- (void)setModel:(GGCatTZAssetModel *)model {
    ...
    if (model.type == TZAssetModelMediaTypePhotoGif) {
        [[PXFunTZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
            ...
            [self resizeSubviews];
            [[PXFunTZImageManager manager] getOriginalPhotoDataWithAsset:model.asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                if (!isDegraded) {
...
- (void)setAsset:(id)asset {
    ...
    _asset = asset;
    self.imageRequestID = [[PXFunTZImageManager manager] getPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
- (void)configMoviePlayer {
    ...
    [[PXFunTZImageManager manager] getPhotoWithAsset:self.model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[PXFunTZImageManager manager] getVideoWithAsset:self.model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
