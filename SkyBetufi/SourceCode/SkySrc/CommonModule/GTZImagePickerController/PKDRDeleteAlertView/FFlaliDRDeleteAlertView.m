...
@interface FFlaliDRDeleteAlertView ()
...
@end
@implementation FFlaliDRDeleteAlertView
- (instancetype)init {
...
+ (void)showDeleteAlertViewWithComplete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    [FFlaliDRDeleteAlertView showWithTitle:@"删除" message:@"确定是否删除？" content:nil complete:complete];
}
...
+ (void)showWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content complete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    FFlaliDRDeleteAlertView *alertView = [[FFlaliDRDeleteAlertView alloc] init];
