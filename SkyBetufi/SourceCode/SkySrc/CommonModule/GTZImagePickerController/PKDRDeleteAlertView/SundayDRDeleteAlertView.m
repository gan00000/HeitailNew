...
@interface SundayDRDeleteAlertView ()
...
@end
@implementation SundayDRDeleteAlertView
- (instancetype)init {
...
+ (void)showDeleteAlertViewWithComplete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    [SundayDRDeleteAlertView showWithTitle:@"删除" message:@"确定是否删除？" content:nil complete:complete];
}
...
+ (void)showWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content complete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    SundayDRDeleteAlertView *alertView = [[SundayDRDeleteAlertView alloc] init];
