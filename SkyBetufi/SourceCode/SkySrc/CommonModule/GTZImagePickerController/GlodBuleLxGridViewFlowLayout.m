#import "GlodBuleLxGridViewFlowLayout.h"
#import "GlodBuleDRPhotoKeyboardCell.h"
...
@interface GlodBuleLxGridViewFlowLayout () <UIGestureRecognizerDelegate>
...
@end
@implementation GlodBuleLxGridViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            GlodBuleDRPhotoKeyboardCell *sourceCell = (GlodBuleDRPhotoKeyboardCell *)sourceCollectionViewCell;
