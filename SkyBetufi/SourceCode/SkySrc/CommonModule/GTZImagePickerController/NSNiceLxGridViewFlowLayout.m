#import "NSNiceLxGridViewFlowLayout.h"
#import "FFlaliDRPhotoKeyboardCell.h"
...
@interface NSNiceLxGridViewFlowLayout () <UIGestureRecognizerDelegate>
...
@end
@implementation NSNiceLxGridViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            FFlaliDRPhotoKeyboardCell *sourceCell = (FFlaliDRPhotoKeyboardCell *)sourceCollectionViewCell;
