...
@class TZAlbumModel,GGCatTZAssetModel;
@protocol TZImagePickerControllerDelegate;
@interface PXFunTZImageManager : NSObject
...
- (void)getAssetsFromFetchResult:(id)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<GGCatTZAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(id)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(GGCatTZAssetModel *model))completion;
