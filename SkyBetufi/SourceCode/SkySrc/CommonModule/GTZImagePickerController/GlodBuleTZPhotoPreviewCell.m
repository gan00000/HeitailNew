...
@end
@implementation GlodBuleTZPhotoPreviewCell
- (void)configSubviews {
...
- (void)setModel:(GlodBuleTZAssetModel *)model {
    ...
    if (model.type == TZAssetModelMediaTypePhotoGif) {
        [[GlodBuleTZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
            ...
            [self resizeSubviews];
            [[GlodBuleTZImageManager manager] getOriginalPhotoDataWithAsset:model.asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                if (!isDegraded) {
...
- (void)setAsset:(id)asset {
    ...
    _asset = asset;
    self.imageRequestID = [[GlodBuleTZImageManager manager] getPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
- (void)configMoviePlayer {
    ...
    [[GlodBuleTZImageManager manager] getPhotoWithAsset:self.model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[GlodBuleTZImageManager manager] getVideoWithAsset:self.model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
