...
@interface YeYeeTZGifPhotoPreviewController () {
    UIView *_toolBar;
...
@end
@implementation YeYeeTZGifPhotoPreviewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)configBottomToolBar {
    ...
    [[NSNiceTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
