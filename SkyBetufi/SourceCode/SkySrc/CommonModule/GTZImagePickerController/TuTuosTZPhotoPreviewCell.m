...
@end
@implementation TuTuosTZPhotoPreviewCell
- (void)configSubviews {
...
- (void)setModel:(UUaksTZAssetModel *)model {
    ...
    if (model.type == TZAssetModelMediaTypePhotoGif) {
        [[NSNiceTZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
            ...
            [self resizeSubviews];
            [[NSNiceTZImageManager manager] getOriginalPhotoDataWithAsset:model.asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                if (!isDegraded) {
...
- (void)setAsset:(id)asset {
    ...
    _asset = asset;
    self.imageRequestID = [[NSNiceTZImageManager manager] getPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
- (void)configMoviePlayer {
    ...
    [[NSNiceTZImageManager manager] getPhotoWithAsset:self.model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[NSNiceTZImageManager manager] getVideoWithAsset:self.model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
