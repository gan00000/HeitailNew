...
+ (NSBundle *)tz_imagePickerBundle {
    NSBundle *bundle = [NSBundle bundleForClass:[BByasTZImagePickerController class]];
    NSURL *url = [bundle URLForResource:@"BByasTZImagePickerController" withExtension:@"bundle"];
