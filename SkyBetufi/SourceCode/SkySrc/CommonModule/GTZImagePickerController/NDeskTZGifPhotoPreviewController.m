...
@interface NDeskTZGifPhotoPreviewController () {
    UIView *_toolBar;
...
@end
@implementation NDeskTZGifPhotoPreviewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)configBottomToolBar {
    ...
    [[PXFunTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
