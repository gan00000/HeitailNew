...
#import "KSasxLMPlayerControlView.h"
#import "BlysaMMMaterialDesignSpinner.h"
#import <Masonry.h>
...
@interface KSasxLMPlayerControlView ()
/** 加载loading */
@property (nonatomic, strong) BlysaMMMaterialDesignSpinner *activity;
/** 快进快退View */
...
@implementation KSasxLMPlayerControlView

+ (instancetype)playerControlViewWithStatusModel:(MMoogLMPlayerStatusModel *)playerStatusModel {
    KSasxLMPlayerControlView *instance = [[self alloc] init];
...
- (UUaksLMLandScapeControlView *)landScapeControlView {
    if (!_landScapeControlView) {
        _landScapeControlView = [[UUaksLMLandScapeControlView alloc] init];
    }
    return _landScapeControlView;
}

- (BlysaMMMaterialDesignSpinner *)activity {
    if (!_activity) {
        _activity = [[BlysaMMMaterialDesignSpinner alloc] init];
