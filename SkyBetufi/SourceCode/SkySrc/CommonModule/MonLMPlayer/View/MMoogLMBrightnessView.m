...
@interface MMoogLMBrightnessView ()
...
@implementation MMoogLMBrightnessView

+ (instancetype)sharedBrightnessView {
    static MMoogLMBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[MMoogLMBrightnessView alloc] init];
