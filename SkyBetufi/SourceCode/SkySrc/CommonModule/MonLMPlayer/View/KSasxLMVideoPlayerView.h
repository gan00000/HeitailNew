...
@interface KSasxLMVideoPlayerView : UIView
/** 视频控制层, 自定义层 */
@property (nonatomic, strong, readonly) KSasxLMPlayerControlView *playerControlView;
/** 未播放, 封面的View */
@property (nonatomic, strong) KSasxLMCoverControlView *coverControlView;
/** 未播放, loading时的View */
@property (nonatomic, strong) NSNiceLMLoadingView *loadingView;
...
+ (instancetype)videoPlayerViewWithSuperView:(UIView *)superview
                           ...
                           playerStatusModel:(MMoogLMPlayerStatusModel *)playerStatusModel;
