...
@interface NDeskLMBrightnessView ()
...
@implementation NDeskLMBrightnessView

+ (instancetype)sharedBrightnessView {
    static NDeskLMBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[NDeskLMBrightnessView alloc] init];
