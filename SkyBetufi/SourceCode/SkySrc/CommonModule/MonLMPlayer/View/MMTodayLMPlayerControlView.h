...
#import "PXFunLMCoverControlView.h"
#import "PXFunLMLoadingView.h"
@class CCCaseLMPlayerStatusModel;
...
@interface MMTodayLMPlayerControlView : UIView
...
/** 竖屏控制层的View */
@property (nonatomic, strong) CCCaseLMPortraitControlView *portraitControlView;
/** 横屏控制层的View */
@property (nonatomic, strong) NDeskLMLandScapeControlView *landScapeControlView;
/** 上次播放至xx秒(默认0) */
