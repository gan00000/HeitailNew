...
#import "UUaksLMLandScapeControlView.h"
#import "KSasxLMCoverControlView.h"
#import "NSNiceLMLoadingView.h"
@class MMoogLMPlayerStatusModel;
...
@interface KSasxLMPlayerControlView : UIView
...
/** 竖屏控制层的View */
@property (nonatomic, strong) UUaksLMPortraitControlView *portraitControlView;
/** 横屏控制层的View */
@property (nonatomic, strong) UUaksLMLandScapeControlView *landScapeControlView;
/** 上次播放至xx秒(默认0) */
