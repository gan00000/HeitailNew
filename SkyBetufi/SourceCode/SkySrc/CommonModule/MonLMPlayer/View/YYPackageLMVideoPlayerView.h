...
@interface YYPackageLMVideoPlayerView : UIView
/** 视频控制层, 自定义层 */
@property (nonatomic, strong, readonly) MMTodayLMPlayerControlView *playerControlView;
/** 未播放, 封面的View */
@property (nonatomic, strong) PXFunLMCoverControlView *coverControlView;
/** 未播放, loading时的View */
@property (nonatomic, strong) PXFunLMLoadingView *loadingView;
...
+ (instancetype)videoPlayerViewWithSuperView:(UIView *)superview
                           ...
                           playerStatusModel:(CCCaseLMPlayerStatusModel *)playerStatusModel;
