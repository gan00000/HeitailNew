...
@interface GlodBuleLMBrightnessView ()
...
@implementation GlodBuleLMBrightnessView

+ (instancetype)sharedBrightnessView {
    static GlodBuleLMBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[GlodBuleLMBrightnessView alloc] init];
