...
@interface GlodBuleLMVideoPlayerView : UIView
/** 视频控制层, 自定义层 */
@property (nonatomic, strong, readonly) GlodBuleLMPlayerControlView *playerControlView;
/** 未播放, 封面的View */
@property (nonatomic, strong) GlodBuleLMCoverControlView *coverControlView;
/** 未播放, loading时的View */
@property (nonatomic, strong) GlodBuleLMLoadingView *loadingView;
...
+ (instancetype)videoPlayerViewWithSuperView:(UIView *)superview
                           ...
                           playerStatusModel:(GlodBuleLMPlayerStatusModel *)playerStatusModel;
