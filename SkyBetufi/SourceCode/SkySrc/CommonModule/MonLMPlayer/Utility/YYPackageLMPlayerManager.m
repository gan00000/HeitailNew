...
@interface YYPackageLMPlayerManager ()
...
@implementation YYPackageLMPlayerManager

+ (instancetype)playerManagerWithDelegate:(id<LMPlayerManagerDelegate>)delegate playerStatusModel:(CCCaseLMPlayerStatusModel *)playerStatusModel {
    
    YYPackageLMPlayerManager *playerMgr = [[YYPackageLMPlayerManager alloc] init];
