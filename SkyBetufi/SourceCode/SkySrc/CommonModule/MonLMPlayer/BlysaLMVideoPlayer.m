...
#import "NSNiceLMPlayerManager.h"
#import "WSKggLMVideoPlayerView.h"
#import "MMoogLMPlayerStatusModel.h"
#import "MMoogLMBrightnessView.h"

@interface BlysaLMVideoPlayer ()<LMPlayerManagerDelegate, LMPlayerControlViewDelagate, LMPortraitControlViewDelegate, LMLandScapeControlViewDelegate, LMVideoPlayerViewDelagate, LMLoadingViewDelegate, LMCoverControlViewDelegate>

// 代理
@property (nonatomic, weak) id<LMVideoPlayerDelegate> delegate;
// 最底层的父视图
@property (nonatomic, strong) WSKggLMVideoPlayerView *videoPlayerView;
// AVPlayer 管理
@property (nonatomic, strong) NSNiceLMPlayerManager *playerMgr;
// 播放数据模型
...
@implementation BlysaLMVideoPlayer
#pragma mark - getter
...
+ (instancetype)videoPlayerWithView:(UIView *)view delegate:(id<LMVideoPlayerDelegate>)delegate playerModel:(BlysaLMPlayerModel *)playerModel {
    ...
    BlysaLMVideoPlayer *instance = [[BlysaLMVideoPlayer alloc] init];
    ...
    // !!!: 最底层视图创建
    instance.videoPlayerView = [WSKggLMVideoPlayerView videoPlayerViewWithSuperView:view delegate:instance playerStatusModel:instance.playerStatusModel];
    ...
    // !!!: 创建AVPlayer管理
    instance.playerMgr = [NSNiceLMPlayerManager playerManagerWithDelegate:instance playerStatusModel:instance.playerStatusModel];
...
- (void)didBuffer:(NSNiceLMPlayerManager *)playerMgr { 
