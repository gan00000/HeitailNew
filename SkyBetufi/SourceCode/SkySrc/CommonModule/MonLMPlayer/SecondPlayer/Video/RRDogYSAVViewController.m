...
#import "RRDogYSAVViewController.h"
#import "CCCaseYSPlayerController.h"
#import "AppDelegate.h"

@interface RRDogYSAVViewController () <YSPlayerControllerDelegate>

@property (strong, nonatomic) CCCaseYSPlayerController *playerController;

@end

@implementation RRDogYSAVViewController
...
//    self.playerController = [[CCCaseYSPlayerController alloc] initWithContentURL:self.fileURL];
