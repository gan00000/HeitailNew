...
#import "TuTuosYSAVViewController.h"
#import "UUaksYSPlayerController.h"
#import "AppDelegate.h"

@interface TuTuosYSAVViewController () <YSPlayerControllerDelegate>

@property (strong, nonatomic) UUaksYSPlayerController *playerController;

@end

@implementation TuTuosYSAVViewController
...
//    self.playerController = [[UUaksYSPlayerController alloc] initWithContentURL:self.fileURL];
