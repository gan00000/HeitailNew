...
#import "WSKggYSPlayerView.h"
#import "Masonry.h"
#import <SDWebImage/UIImageView+WebCache.h>
#import "PLMediaInfo.h"

@interface UUaksYSPlayerController () <YSPlayerControlDelegate>

@property (strong, nonatomic) WSKggYSPlayerView *playerView;
...
@implementation UUaksYSPlayerController
...
- (WSKggYSPlayerView *)playerView {
    if (!_playerView) {
        _playerView = [[WSKggYSPlayerView alloc] init];
