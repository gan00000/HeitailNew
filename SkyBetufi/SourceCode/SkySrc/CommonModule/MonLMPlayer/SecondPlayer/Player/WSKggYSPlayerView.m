...
#import "UIImage+TuTuosCCCaseResize.h"

@interface WSKggYSPlayerView ()
...
@implementation WSKggYSPlayerView
...
{
    if (!_playControl) {
        _playControl = [[NSBundle mainBundle] loadNibNamed:@"MMoogYSPlayerControl" owner:nil options:nil][0];
    }
    return _playControl;
