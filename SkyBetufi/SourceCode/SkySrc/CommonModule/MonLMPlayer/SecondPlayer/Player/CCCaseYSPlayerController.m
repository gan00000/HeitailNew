...
@interface CCCaseYSPlayerController () <YSPlayerControlDelegate>

@property (strong, nonatomic) NDeskYSPlayerView *playerView;
...
@implementation CCCaseYSPlayerController
...
- (NDeskYSPlayerView *)playerView {
    if (!_playerView) {
        _playerView = [[NDeskYSPlayerView alloc] init];
