...
#import "GlodBuleLMPlayerManager.h"
#import "GlodBuleLMVideoPlayerView.h"
#import "GlodBuleLMPlayerStatusModel.h"
#import "GlodBuleLMBrightnessView.h"

@interface GlodBuleLMVideoPlayer ()<LMPlayerManagerDelegate, LMPlayerControlViewDelagate, LMPortraitControlViewDelegate, LMLandScapeControlViewDelegate, LMVideoPlayerViewDelagate, LMLoadingViewDelegate, LMCoverControlViewDelegate>

// 代理
@property (nonatomic, weak) id<LMVideoPlayerDelegate> delegate;
// 最底层的父视图
@property (nonatomic, strong) GlodBuleLMVideoPlayerView *videoPlayerView;
// AVPlayer 管理
@property (nonatomic, strong) GlodBuleLMPlayerManager *playerMgr;
// 播放数据模型
@property (nonatomic, strong) GlodBuleLMPlayerModel *playerModel;
/** 播放器的参数模型 */
@property (nonatomic, strong) GlodBuleLMPlayerStatusModel *playerStatusModel;
...
@implementation GlodBuleLMVideoPlayer
#pragma mark - getter
...
+ (instancetype)videoPlayerWithView:(UIView *)view delegate:(id<LMVideoPlayerDelegate>)delegate playerModel:(GlodBuleLMPlayerModel *)playerModel {
    
    if (view == nil) {
        return nil;
    }
    
    GlodBuleLMVideoPlayer *instance = [[GlodBuleLMVideoPlayer alloc] init];
    ...
    // !!!: 最底层视图创建
    instance.videoPlayerView = [GlodBuleLMVideoPlayerView videoPlayerViewWithSuperView:view delegate:instance playerStatusModel:instance.playerStatusModel];
    ...
    // !!!: 创建AVPlayer管理
    instance.playerMgr = [GlodBuleLMPlayerManager playerManagerWithDelegate:instance playerStatusModel:instance.playerStatusModel];
...
//- (void)setPlayerModel:(GlodBuleLMPlayerModel *)playerModel {
...
- (void)didBuffer:(GlodBuleLMPlayerManager *)playerMgr { 
...
//    }
    ...
    GlodBuleLMPlayerModel *newModel = [[GlodBuleLMPlayerModel alloc] init];
