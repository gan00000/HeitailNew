...
@interface GlodBuleLMPlayerManager ()
...
@implementation GlodBuleLMPlayerManager

+ (instancetype)playerManagerWithDelegate:(id<LMPlayerManagerDelegate>)delegate playerStatusModel:(GlodBuleLMPlayerStatusModel *)playerStatusModel {
    
    GlodBuleLMPlayerManager *playerMgr = [[GlodBuleLMPlayerManager alloc] init];
