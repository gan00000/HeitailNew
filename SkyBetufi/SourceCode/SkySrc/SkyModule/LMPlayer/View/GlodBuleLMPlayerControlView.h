...
#import "GlodBuleLMPortraitControlView.h"
#import "GlodBuleLMLandScapeControlView.h"
#import "GlodBuleLMCoverControlView.h"
#import "GlodBuleLMLoadingView.h"
@class GlodBuleLMPlayerStatusModel;
...
@interface GlodBuleLMPlayerControlView : UIView
...
/** 竖屏控制层的View */
@property (nonatomic, strong) GlodBuleLMPortraitControlView *portraitControlView;
/** 横屏控制层的View */
@property (nonatomic, strong) GlodBuleLMLandScapeControlView *landScapeControlView;
/** 上次播放至xx秒(默认0) */
