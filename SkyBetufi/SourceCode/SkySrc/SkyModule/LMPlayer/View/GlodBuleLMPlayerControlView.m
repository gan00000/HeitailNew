...
#import "GlodBuleLMPlayerControlView.h"
#import "GlodBuleMMMaterialDesignSpinner.h"
#import <Masonry.h>
...
@interface GlodBuleLMPlayerControlView ()
/** 加载loading */
@property (nonatomic, strong) GlodBuleMMMaterialDesignSpinner *activity;
/** 快进快退View */
...
@implementation GlodBuleLMPlayerControlView

+ (instancetype)playerControlViewWithStatusModel:(GlodBuleLMPlayerStatusModel *)playerStatusModel {
    GlodBuleLMPlayerControlView *instance = [[self alloc] init];
...
- (GlodBuleLMPortraitControlView *)portraitControlView {
    if (!_portraitControlView) {
        _portraitControlView = [[GlodBuleLMPortraitControlView alloc] init];
    }
    return _portraitControlView;
}

- (GlodBuleLMLandScapeControlView *)landScapeControlView {
    if (!_landScapeControlView) {
        _landScapeControlView = [[GlodBuleLMLandScapeControlView alloc] init];
    }
    return _landScapeControlView;
}

- (GlodBuleMMMaterialDesignSpinner *)activity {
    if (!_activity) {
        _activity = [[GlodBuleMMMaterialDesignSpinner alloc] init];
