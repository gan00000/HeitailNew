...
#import "GlodBuleWBImageBrowserView.h"
#import "GlodBuleWBImageBrowserCell.h"
...
@interface GlodBuleWBImageBrowserView () <UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation GlodBuleWBImageBrowserView
...
+ (instancetype)pictureBrowsweViewWithFrame:(CGRect)frame delegate:(id<WBImageBrowserViewDelegate>)delegate browserInfoArray:(NSArray *)browserInfoArray {
    GlodBuleWBImageBrowserView *pictureBrowserView = [[self alloc] initWithFrame:frame];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GlodBuleWBImageBrowserCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    GlodBuleWBImageBrowserCell *cell1 = (GlodBuleWBImageBrowserCell *)cell;
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[GlodBuleWBImageBrowserCell class] forCellWithReuseIdentifier:cellID];
...
- (void)shareButtonButtonClick {
    ...
    kWeakSelf
    [GlodBuleHTLoginAlertView waterSkyshowShareAlertViewWithSelectBlock:^(HTLoginPlatform platform) {
...
//            if (weakSelf.img_url) {
//                [GlodBuleBJLoadingHud showHUDInView:[GlodBulePPXXBJViewControllerCenter currentViewController].view];
...
//                        [weakSelf doShareToPlatform:UMSocialPlatformType_Line withMessage:messageObject];
//                    }
//                    [GlodBuleBJLoadingHud hideHUDInView:[GlodBulePPXXBJViewControllerCenter currentViewController].view];
//                }];
//            } else {
//                [weakSelf doShareToPlatform:UMSocialPlatformType_Line withMessage:messageObject];
//            }
