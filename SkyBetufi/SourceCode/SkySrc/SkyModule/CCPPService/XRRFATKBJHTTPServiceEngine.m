...
+ (instancetype)sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [instance.httpEngine updateSessionWithBlock:^(AFHTTPSessionManager *session) {
            ...
            [session.requestSerializer setValue:[NSString stringWithFormat:@"%@|%@|%@", [XRRFATKBJUtility modelName], [XRRFATKBJUtility systemVersion], [XRRFATKBJUtility idfa]] forHTTPHeaderField:@"X-User-Device"]; //机器名称 | 系统版本 | idfa
...
+ (void)getRequestWithFunctionPath:(NSString *)path
    ...
    [[XRRFATKBJHTTPServiceEngine sharedInstance].httpEngine getRequestWithFunctionPath:path params:allParams successBlock:^(NSURLSessionDataTask *task, id responseData) {
...
+ (void)postRequestWithFunctionPath:(NSString *)path
    ...
    [[XRRFATKBJHTTPServiceEngine sharedInstance].httpEngine postRequestWithFunctionPath:path params:allParams successBlock:^(NSURLSessionDataTask *task, id responseData) {
...
+ (void)fileUploadWithFunctionPath:(NSString *)functionPath
    ...
    [[XRRFATKBJHTTPServiceEngine sharedInstance].httpEngine fileUploadWithFunctionPath:functionPath params:params fileData:fileData fileName:fileName mimeType:mimeType progressBlock:^(float progress) {
...
+ (void)imageUploadWithFunctionPath:(NSString *)functionPath
    ...
    [[XRRFATKBJHTTPServiceEngine sharedInstance].httpEngine imageUploadWithFunctionPath:functionPath params:params imageData:imageData imageName:imageName progressBlock:^(float progress) {
