...
@implementation SkyBallHetiRedBJUtility
@end
@implementation SkyBallHetiRedBJUtility (App)
...
@end
@implementation SkyBallHetiRedBJUtility (Device)
+ (NSString *)modelName {
...
@end
@implementation SkyBallHetiRedBJUtility (Carrier)
