...
@implementation SkyBallHetiRedBJDateFormatUtility
...
+ (NSString *)dateToShowFromDateString:(NSString *)dateString dateFormat:(NSString *)dateFormat {
    ...
    return [SkyBallHetiRedBJDateFormatUtility dateToShowFromDate:[formatter dateFromString:dateString]];
}
+ (NSString *)dateToShowFromTimeInterval:(NSTimeInterval)timeInterval {
    return [SkyBallHetiRedBJDateFormatUtility dateToShowFromDate:[NSDate dateWithTimeIntervalSince1970:timeInterval]];
}
@end
