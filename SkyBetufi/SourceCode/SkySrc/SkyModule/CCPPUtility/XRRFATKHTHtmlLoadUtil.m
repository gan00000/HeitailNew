...
@interface XRRFATKHTHtmlLoadUtil ()
...
@implementation XRRFATKHTHtmlLoadUtil

+ (instancetype)sharedInstance {
    static XRRFATKHTHtmlLoadUtil *util;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        util = [[XRRFATKHTHtmlLoadUtil alloc] init];
    });
    return util;
}
