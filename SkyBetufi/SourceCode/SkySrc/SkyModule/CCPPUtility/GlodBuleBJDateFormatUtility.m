...
@implementation GlodBuleBJDateFormatUtility
...
+ (NSString *)dateToShowFromDateString:(NSString *)dateString dateFormat:(NSString *)dateFormat {
    ...
    return [GlodBuleBJDateFormatUtility dateToShowFromDate:[formatter dateFromString:dateString]];
}
+ (NSString *)dateToShowFromTimeInterval:(NSTimeInterval)timeInterval {
    return [GlodBuleBJDateFormatUtility dateToShowFromDate:[NSDate dateWithTimeIntervalSince1970:timeInterval]];
}
@end
