...
@interface SkyBallHetiRedHTHtmlLoadUtil ()
@property (nonatomic, copy) NSString *svgHtml;
@property (nonatomic, copy) NSString *iframeHtml;
@end
@implementation SkyBallHetiRedHTHtmlLoadUtil
+ (instancetype)sharedInstance {
    static SkyBallHetiRedHTHtmlLoadUtil *util;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        util = [[SkyBallHetiRedHTHtmlLoadUtil alloc] init];
    });
    return util;
}
- (instancetype)init
