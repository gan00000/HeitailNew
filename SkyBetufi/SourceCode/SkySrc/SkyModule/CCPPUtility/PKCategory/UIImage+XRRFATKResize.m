//
//  UIImage+XRRFATKResize.m
//

#import "UIImage+XRRFATKResize.h"

@implementation UIImage (XRRFATKResize)
     ...
     interpolationQuality:(CGInterpolationQuality)quality
{
    ...
    CGContextRef bitmap = CGBitmapContextCreate(NULL,
                                                ...
                                                colorSpace,
                                                // modified by xudongyang at 2012-07-20
                                                (CGBitmapInfo)kCGImageAlphaNoneSkipLast);//CGImageGetBitmapInfo(imageRef));
