//
//  SkyBallHetiRedDHGuidePageHUD.h
...
typedef void(^ClickListener)(NSInteger m);

@interface SkyBallHetiRedDHGuidePageHUD : UIView
/**
...
/**
 *  SkyBallHetiRedDHGuidePageHUD(图片引导页 | 可自动识别动态图片和静态图片)
 *
 *  @param frame      位置大小
...
/**
 *  SkyBallHetiRedDHGuidePageHUD(视频引导页)
 *
 *  @param frame    位置大小
