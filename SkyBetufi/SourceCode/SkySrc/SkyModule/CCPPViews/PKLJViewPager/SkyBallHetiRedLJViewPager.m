#import "SkyBallHetiRedLJViewPager.h"
#import "SkyBallHetiRedLJTabBar.h"
@protocol UIScrollViewDelegateAdapter <UIScrollViewDelegate>
@end
@interface SkyBallHetiRedLJViewPager () <UIScrollViewDelegate>
...
@end
@implementation SkyBallHetiRedLJViewPager
- (instancetype)init {
    if (self == [super init]) {
        [self setup];
    }
...
- (void)setTabBar:(SkyBallHetiRedLJTabBar *)tabBar {
    _tabBar = tabBar;
