...
@interface SkyBallHetiRedBJURINavigator ()
@property (nonatomic, strong) NSMutableDictionary *uriHandlerDict;
@end
@implementation SkyBallHetiRedBJURINavigator
+ (instancetype)sharedInstance {
    static SkyBallHetiRedBJURINavigator *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[SkyBallHetiRedBJURINavigator alloc] init];
