...
@interface SkyBallHetiRedBJWebViewController ()
...
@property (nonatomic, strong) SkyBallHetiRedBJWebViewJSBridge *jsBridge;
...
@end
@implementation SkyBallHetiRedBJWebViewController
...
- (void)setupJSBridge {
    self.jsBridge = [[SkyBallHetiRedBJWebViewJSBridge alloc] initWithWebView:self.webView viewController:self];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([navigationAction.request.URL.scheme isEqualToString:BJURIScheme]) {
        BOOL result = [[SkyBallHetiRedBJURINavigator sharedInstance] handleURI:url];
        if (result) {
