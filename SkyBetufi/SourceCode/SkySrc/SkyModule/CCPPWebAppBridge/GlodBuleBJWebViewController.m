...
@interface GlodBuleBJWebViewController ()
...
@property (nonatomic, strong) GlodBuleBJWebViewJSBridge *jsBridge;
...
@end
@implementation GlodBuleBJWebViewController
...
- (void)setupJSBridge {
    self.jsBridge = [[GlodBuleBJWebViewJSBridge alloc] initWithWebView:self.webView viewController:self];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([navigationAction.request.URL.scheme isEqualToString:BJURIScheme]) {
        BOOL result = [[GlodBuleBJURINavigator sharedInstance] handleURI:url];
        if (result) {
