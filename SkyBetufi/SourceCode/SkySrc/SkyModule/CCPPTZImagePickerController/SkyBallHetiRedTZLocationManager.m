...
@interface SkyBallHetiRedTZLocationManager ()<CLLocationManagerDelegate>
...
@end
@implementation SkyBallHetiRedTZLocationManager
+ (instancetype)manager {
    static SkyBallHetiRedTZLocationManager *manager;
