...
@class TZAlbumModel,XRRFATKTZAssetModel;
@protocol TZImagePickerControllerDelegate;
@interface XRRFATKTZImageManager : NSObject
...
- (void)getAssetsFromFetchResult:(id)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<XRRFATKTZAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(id)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(XRRFATKTZAssetModel *model))completion;
