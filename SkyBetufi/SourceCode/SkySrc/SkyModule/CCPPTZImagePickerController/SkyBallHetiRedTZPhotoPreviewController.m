...
#import "SkyBallHetiRedTZPhotoPreviewCell.h"
...
#import "SkyBallHetiRedTZImageCropManager.h"
@interface SkyBallHetiRedTZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@end
@implementation SkyBallHetiRedTZPhotoPreviewController
...
- (void)viewDidLoad {
    ...
    SkyBallHetiRedTZImagePickerController *_tzImagePickerVc = (SkyBallHetiRedTZImagePickerController *)weakSelf.navigationController;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [SkyBallHetiRedTZImageManager manager].shouldFixOrientation = NO;
}
...
- (void)configBottomToolBar {
    ...
    SkyBallHetiRedTZImagePickerController *_tzImagePickerVc = (SkyBallHetiRedTZImagePickerController *)self.navigationController;
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[SkyBallHetiRedTZPhotoPreviewCell class] forCellWithReuseIdentifier:@"SkyBallHetiRedTZPhotoPreviewCell"];
...
- (void)configCropView {
    ...
    if (!_tzImagePickerVc.showSelectBtn && _tzImagePickerVc.allowCrop) {
        ...
        [SkyBallHetiRedTZImageCropManager overlayClippingWithView:_cropBgView cropRect:_tzImagePickerVc.cropRect containerView:self.view needCircleCrop:_tzImagePickerVc.needCircleCrop];
...
- (void)select:(UIButton *)selectButton {
    SkyBallHetiRedTZImagePickerController *_tzImagePickerVc = (SkyBallHetiRedTZImagePickerController *)self.navigationController;
    SkyBallHetiRedTZAssetModel *model = _models[_currentIndex];
        ...
        for (SkyBallHetiRedTZAssetModel *model_item in selectedModels) {
            if ([[[SkyBallHetiRedTZImageManager manager] getAssetIdentifier:model.asset] isEqualToString:[[SkyBallHetiRedTZImageManager manager] getAssetIdentifier:model_item.asset]]) {
                ...
                for (NSInteger i = 0; i < selectedModelsTmp.count; i++) {
                    SkyBallHetiRedTZAssetModel *model = selectedModelsTmp[i];
...
- (void)doneButtonClick {
    ...
    if (_tzImagePickerVc.allowCrop) { 
        ...
        SkyBallHetiRedTZPhotoPreviewCell *cell = (SkyBallHetiRedTZPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
        UIImage *cropedImage = [SkyBallHetiRedTZImageCropManager cropImageView:cell.previewView.imageView toRect:_tzImagePickerVc.cropRect zoomScale:cell.previewView.scrollView.zoomScale containerView:self.view];
        if (_tzImagePickerVc.needCircleCrop) {
            cropedImage = [SkyBallHetiRedTZImageCropManager circularClipImage:cropedImage];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    SkyBallHetiRedTZImagePickerController *_tzImagePickerVc = (SkyBallHetiRedTZImagePickerController *)self.navigationController;
    SkyBallHetiRedTZAssetModel *model = _models[indexPath.row];
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"SkyBallHetiRedTZPhotoPreviewCell" forIndexPath:indexPath];
        SkyBallHetiRedTZPhotoPreviewCell *photoPreviewCell = (SkyBallHetiRedTZPhotoPreviewCell *)cell;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:[SkyBallHetiRedTZPhotoPreviewCell class]]) {
        [(SkyBallHetiRedTZPhotoPreviewCell *)cell recoverSubviews];
    }
}
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    if (![[SkyBallHetiRedTZImageManager manager] isPhotoSelectableWithAsset:model.asset]) {
...
- (void)showPhotoBytes {
    [[SkyBallHetiRedTZImageManager manager] getPhotosBytesWithArray:@[_models[_currentIndex]] completion:^(NSString *totalBytes) {
