...
@class TZAlbumModel,GlodBuleTZAssetModel;
@protocol TZImagePickerControllerDelegate;
@interface GlodBuleTZImageManager : NSObject
...
- (void)getAssetsFromFetchResult:(id)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<GlodBuleTZAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(id)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(GlodBuleTZAssetModel *model))completion;
