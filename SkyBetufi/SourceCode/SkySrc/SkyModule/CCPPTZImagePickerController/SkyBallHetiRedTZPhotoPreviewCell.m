...
@end
@implementation SkyBallHetiRedTZPhotoPreviewCell
- (void)configSubviews {
...
- (void)setModel:(SkyBallHetiRedTZAssetModel *)model {
    ...
    if (model.type == TZAssetModelMediaTypePhotoGif) {
        [[SkyBallHetiRedTZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
            ...
            [self resizeSubviews];
            [[SkyBallHetiRedTZImageManager manager] getOriginalPhotoDataWithAsset:model.asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                if (!isDegraded) {
...
- (void)setAsset:(id)asset {
    ...
    _asset = asset;
    self.imageRequestID = [[SkyBallHetiRedTZImageManager manager] getPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
- (void)configMoviePlayer {
    ...
    [[SkyBallHetiRedTZImageManager manager] getPhotoWithAsset:self.model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[SkyBallHetiRedTZImageManager manager] getVideoWithAsset:self.model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
