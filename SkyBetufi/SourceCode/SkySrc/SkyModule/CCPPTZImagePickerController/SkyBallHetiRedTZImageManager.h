...
@class TZAlbumModel,SkyBallHetiRedTZAssetModel;
@protocol TZImagePickerControllerDelegate;
@interface SkyBallHetiRedTZImageManager : NSObject
...
- (void)getAssetsFromFetchResult:(id)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<SkyBallHetiRedTZAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(id)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(SkyBallHetiRedTZAssetModel *model))completion;
