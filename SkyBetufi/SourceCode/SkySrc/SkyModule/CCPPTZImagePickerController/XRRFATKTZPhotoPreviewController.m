//
//  XRRFATKTZPhotoPreviewController.m
...
@interface XRRFATKTZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation XRRFATKTZPhotoPreviewController
...
- (void)viewDidLoad {
    ...
    XRRFATKTZImagePickerController *_tzImagePickerVc = (XRRFATKTZImagePickerController *)weakSelf.navigationController;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [XRRFATKTZImageManager manager].shouldFixOrientation = NO;
}
...
- (void)configBottomToolBar {
    ...
    XRRFATKTZImagePickerController *_tzImagePickerVc = (XRRFATKTZImagePickerController *)self.navigationController;
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[XRRFATKTZPhotoPreviewCell class] forCellWithReuseIdentifier:@"XRRFATKTZPhotoPreviewCell"];
...
- (void)configCropView {
    ...
    if (!_tzImagePickerVc.showSelectBtn && _tzImagePickerVc.allowCrop) {
        ...
        [XRRFATKTZImageCropManager overlayClippingWithView:_cropBgView cropRect:_tzImagePickerVc.cropRect containerView:self.view needCircleCrop:_tzImagePickerVc.needCircleCrop];
...
- (void)select:(UIButton *)selectButton {
    XRRFATKTZImagePickerController *_tzImagePickerVc = (XRRFATKTZImagePickerController *)self.navigationController;
    XRRFATKTZAssetModel *model = _models[_currentIndex];
        ...
        for (XRRFATKTZAssetModel *model_item in selectedModels) {
            if ([[[XRRFATKTZImageManager manager] getAssetIdentifier:model.asset] isEqualToString:[[XRRFATKTZImageManager manager] getAssetIdentifier:model_item.asset]]) {
                ...
                for (NSInteger i = 0; i < selectedModelsTmp.count; i++) {
                    XRRFATKTZAssetModel *model = selectedModelsTmp[i];
...
- (void)doneButtonClick {
    ...
    if (_tzImagePickerVc.allowCrop) { // 裁剪状态
        ...
        XRRFATKTZPhotoPreviewCell *cell = (XRRFATKTZPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
        UIImage *cropedImage = [XRRFATKTZImageCropManager cropImageView:cell.previewView.imageView toRect:_tzImagePickerVc.cropRect zoomScale:cell.previewView.scrollView.zoomScale containerView:self.view];
        if (_tzImagePickerVc.needCircleCrop) {
            cropedImage = [XRRFATKTZImageCropManager circularClipImage:cropedImage];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    XRRFATKTZImagePickerController *_tzImagePickerVc = (XRRFATKTZImagePickerController *)self.navigationController;
    XRRFATKTZAssetModel *model = _models[indexPath.row];
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"XRRFATKTZPhotoPreviewCell" forIndexPath:indexPath];
        XRRFATKTZPhotoPreviewCell *photoPreviewCell = (XRRFATKTZPhotoPreviewCell *)cell;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:[XRRFATKTZPhotoPreviewCell class]]) {
        [(XRRFATKTZPhotoPreviewCell *)cell recoverSubviews];
    }
}
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    if (![[XRRFATKTZImageManager manager] isPhotoSelectableWithAsset:model.asset]) {
...
- (void)showPhotoBytes {
    [[XRRFATKTZImageManager manager] getPhotosBytesWithArray:@[_models[_currentIndex]] completion:^(NSString *totalBytes) {
