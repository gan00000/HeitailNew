...
+ (NSBundle *)tz_imagePickerBundle {
    NSBundle *bundle = [NSBundle bundleForClass:[GlodBuleTZImagePickerController class]];
    NSURL *url = [bundle URLForResource:@"GlodBuleTZImagePickerController" withExtension:@"bundle"];
