...
@interface SkyBallHetiRedTZGifPhotoPreviewController () {
    UIView *_toolBar;
...
@end
@implementation SkyBallHetiRedTZGifPhotoPreviewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)configBottomToolBar {
    ...
    [[SkyBallHetiRedTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
