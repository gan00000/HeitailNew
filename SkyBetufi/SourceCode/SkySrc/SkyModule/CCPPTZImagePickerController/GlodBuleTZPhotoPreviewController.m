...
#import "GlodBuleTZPhotoPreviewCell.h"
...
#import "GlodBuleTZImageCropManager.h"
@interface GlodBuleTZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@end
@implementation GlodBuleTZPhotoPreviewController
...
- (void)viewDidLoad {
    ...
    GlodBuleTZImagePickerController *_tzImagePickerVc = (GlodBuleTZImagePickerController *)weakSelf.navigationController;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [GlodBuleTZImageManager manager].shouldFixOrientation = NO;
}
...
- (void)configBottomToolBar {
    ...
    GlodBuleTZImagePickerController *_tzImagePickerVc = (GlodBuleTZImagePickerController *)self.navigationController;
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[GlodBuleTZPhotoPreviewCell class] forCellWithReuseIdentifier:@"GlodBuleTZPhotoPreviewCell"];
...
- (void)configCropView {
    ...
    if (!_tzImagePickerVc.showSelectBtn && _tzImagePickerVc.allowCrop) {
        ...
        [GlodBuleTZImageCropManager overlayClippingWithView:_cropBgView cropRect:_tzImagePickerVc.cropRect containerView:self.view needCircleCrop:_tzImagePickerVc.needCircleCrop];
...
- (void)select:(UIButton *)selectButton {
    GlodBuleTZImagePickerController *_tzImagePickerVc = (GlodBuleTZImagePickerController *)self.navigationController;
    GlodBuleTZAssetModel *model = _models[_currentIndex];
        ...
        for (GlodBuleTZAssetModel *model_item in selectedModels) {
            if ([[[GlodBuleTZImageManager manager] getAssetIdentifier:model.asset] isEqualToString:[[GlodBuleTZImageManager manager] getAssetIdentifier:model_item.asset]]) {
                ...
                for (NSInteger i = 0; i < selectedModelsTmp.count; i++) {
                    GlodBuleTZAssetModel *model = selectedModelsTmp[i];
...
- (void)doneButtonClick {
    ...
    if (_tzImagePickerVc.allowCrop) { 
        ...
        GlodBuleTZPhotoPreviewCell *cell = (GlodBuleTZPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
        UIImage *cropedImage = [GlodBuleTZImageCropManager cropImageView:cell.previewView.imageView toRect:_tzImagePickerVc.cropRect zoomScale:cell.previewView.scrollView.zoomScale containerView:self.view];
        if (_tzImagePickerVc.needCircleCrop) {
            cropedImage = [GlodBuleTZImageCropManager circularClipImage:cropedImage];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    GlodBuleTZImagePickerController *_tzImagePickerVc = (GlodBuleTZImagePickerController *)self.navigationController;
    GlodBuleTZAssetModel *model = _models[indexPath.row];
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GlodBuleTZPhotoPreviewCell" forIndexPath:indexPath];
        GlodBuleTZPhotoPreviewCell *photoPreviewCell = (GlodBuleTZPhotoPreviewCell *)cell;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:[GlodBuleTZPhotoPreviewCell class]]) {
        [(GlodBuleTZPhotoPreviewCell *)cell recoverSubviews];
    }
}
...
- (void)showPhotoBytes {
    [[GlodBuleTZImageManager manager] getPhotosBytesWithArray:@[_models[_currentIndex]] completion:^(NSString *totalBytes) {
