...
@interface SkyBallHetiRedDRDeleteAlertView ()
...
@end
@implementation SkyBallHetiRedDRDeleteAlertView
- (instancetype)init {
...
+ (void)showDeleteAlertViewWithComplete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    [SkyBallHetiRedDRDeleteAlertView showWithTitle:@"删除" message:@"确定是否删除？" content:nil complete:complete];
}
...
+ (void)showWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content complete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    SkyBallHetiRedDRDeleteAlertView *alertView = [[SkyBallHetiRedDRDeleteAlertView alloc] init];
