...
@interface XRRFATKDRDeleteAlertView ()
...
@implementation XRRFATKDRDeleteAlertView
...
+ (void)showDeleteAlertViewWithComplete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    [XRRFATKDRDeleteAlertView showWithTitle:@"删除" message:@"确定是否删除？" content:nil complete:complete];
}
...
+ (void)showWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content complete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    XRRFATKDRDeleteAlertView *alertView = [[XRRFATKDRDeleteAlertView alloc] init];
