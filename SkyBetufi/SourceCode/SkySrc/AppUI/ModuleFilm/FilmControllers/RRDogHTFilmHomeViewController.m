...
@interface RRDogHTFilmHomeViewController ()<UITableViewDelegate, UITableViewDataSource, PlayerTableViewCellDelegate>
...
//    NSArray *array = [self.tableView visibleCells];
//
//    KMonkeyHTFilmHomeCell *playCell = nil;
...
//    for (KMonkeyHTFilmHomeCell *cell in array) {
//        CGRect rc = [self.tableView convertRect:cell.frame toView:self.view];
//        rc.size.height -= [KMonkeyHTFilmHomeCell headerViewHeight];
