...
@interface CfipyHTCollectionViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<CfipyHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation CfipyHTCollectionViewController
+ (instancetype)taoviewController {
    return [[CfipyHTCollectionViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的收藏";
...
- (void)loadData {
    [NSNiceHTUserRequest taorequestCollectionListWithOffset:self.offset successBlock:^(NSArray<CfipyHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
