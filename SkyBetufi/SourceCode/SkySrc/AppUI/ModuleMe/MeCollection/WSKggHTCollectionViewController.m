...
@interface WSKggHTCollectionViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<UUaksHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation WSKggHTCollectionViewController
+ (instancetype)taoviewController {
    return [[WSKggHTCollectionViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的收藏";
...
- (void)loadData {
    [TuTuosHTUserRequest taorequestCollectionListWithOffset:self.offset successBlock:^(NSArray<UUaksHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
