...
@interface YeYeeHTShowUpdateInfoView()
...
@implementation YeYeeHTShowUpdateInfoView


+ (void)showWithData:(YeYeeHTUpdateInfoModel *)model {
    YeYeeHTShowUpdateInfoView *alertView = kLoadXibWithName(NSStringFromClass([self class]));
