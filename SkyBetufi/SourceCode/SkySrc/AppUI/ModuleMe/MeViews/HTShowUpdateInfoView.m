...
@interface HTShowUpdateInfoView()
...
@implementation HTShowUpdateInfoView


+ (void)showWithData:(HTUpdateInfoModel *)model {
    HTShowUpdateInfoView *alertView = kLoadXibWithName(NSStringFromClass([self class]));
