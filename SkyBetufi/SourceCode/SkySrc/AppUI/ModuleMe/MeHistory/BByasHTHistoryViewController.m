...
@interface BByasHTHistoryViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<UUaksHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation BByasHTHistoryViewController
+ (instancetype)taoviewController {
    return [[BByasHTHistoryViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"瀏覽歷史";
...
- (void)loadData {
    [TuTuosHTUserRequest taorequestHistoryWithOffset:self.offset successBlock:^(NSArray<UUaksHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
