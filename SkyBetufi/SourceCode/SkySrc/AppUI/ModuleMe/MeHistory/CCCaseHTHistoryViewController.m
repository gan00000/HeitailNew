...
@interface CCCaseHTHistoryViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<PXFunHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation CCCaseHTHistoryViewController
+ (instancetype)taoviewController {
    return [[CCCaseHTHistoryViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"瀏覽歷史";
...
- (void)loadData {
    [HourseHTUserRequest taorequestHistoryWithOffset:self.offset successBlock:^(NSArray<PXFunHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
