...
@interface KMonkeyHTCommentViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<PXFunHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation KMonkeyHTCommentViewController
+ (instancetype)taoviewController {
    return [[KMonkeyHTCommentViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的評論";
...
- (void)loadData {
    [HourseHTUserRequest taorequestMyCommentWithOffset:self.offset successBlock:^(NSArray<PXFunHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
