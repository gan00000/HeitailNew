...
#import "GlodBuleHTMyMessageModel.h"
NS_ASSUME_NONNULL_BEGIN
typedef void (^HTMyCommentBlock) (NSArray <GlodBuleHTNewsModel *> *newsList, NSInteger pages);
@interface GlodBuleHTUserRequest : NSObject
