...
@interface YeYeeHTDataHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation YeYeeHTDataHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        WSKggHTRankEastWestViewController *vc = [WSKggHTRankEastWestViewController taoviewController];
        //vc.type = index + 1;
    ...
    FFlaliHTDataHomeSubViewController *vc = [FFlaliHTDataHomeSubViewController taoviewController];
    if (index == 0) {
        vc.type = 1;//球员1
    } else if(index == 2){
         vc.type = 2;//球队2
