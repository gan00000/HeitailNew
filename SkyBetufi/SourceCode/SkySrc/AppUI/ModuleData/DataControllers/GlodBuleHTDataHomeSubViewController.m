...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GlodBuleHTDataMoreViewController *moreVc = [GlodBuleHTDataMoreViewController taoviewController];
...
- (void)loadData {
    [GlodBuleHTDataHomeRequest taorequestWithType:self.type successBlock:^(GlodBuleHTDataHomeInfoModel *infoModel) {
