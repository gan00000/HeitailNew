...
@interface FFlaliHTDataTeamRightCell ()
...
@end
@implementation FFlaliHTDataTeamRightCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taorefreshWithTeamModel:(TuTuosHTDataTeamRankModel *)teamModel row:(NSInteger)row {
