...
@interface GlodBuleHTDataPlayerRightCell ()
...
@end
@implementation GlodBuleHTDataPlayerRightCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taorefreshWithPlayerModel:(GlodBuleHTDataPlayerRankModel *)playerModel row:(NSInteger)row {
