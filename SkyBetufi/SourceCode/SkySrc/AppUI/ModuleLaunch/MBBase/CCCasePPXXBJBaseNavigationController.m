...
@interface CCCasePPXXBJBaseNavigationController () <UIGestureRecognizerDelegate, UINavigationControllerDelegate>
@end
@implementation CCCasePPXXBJBaseNavigationController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.viewControllers.count > 1 ||
        (![self isKindOfClass:[NDeskHTNewMatchHomeViewController class]] &&
         ![self isKindOfClass:[NDeskHTNewsHomeViewController class]] &&
