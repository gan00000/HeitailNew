...
@interface BByasPPXXBJBaseNavigationController () <UIGestureRecognizerDelegate, UINavigationControllerDelegate>
@end
@implementation BByasPPXXBJBaseNavigationController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.viewControllers.count > 1 ||
        (![self isKindOfClass:[NSNiceHTNewMatchHomeViewController class]] &&
         ![self isKindOfClass:[BlysaHTNewsHomeViewController class]] &&
         ![self isKindOfClass:[TuTuosHTFilmHomeViewController class]] &&
         ![self isKindOfClass:[YeYeeHTDataHomeViewController class]] &&
         ![self isKindOfClass:[FFlaliHTMainPageViewController class]] &&
         ![self isKindOfClass:[BByasMainLanmuViewController class]] &&
         
         ![self isKindOfClass:[YeYeeHTRankHomeViewController class]])) {
