...
- (NSArray<Class> *)taoviewControllersNotHideTabBar {
    return @[[NDeskHTNewMatchHomeViewController class],
             [NDeskHTNewsHomeViewController class],
             [RRDogHTFilmHomeViewController class],
             [MMTodayHTDataHomeViewController class],
