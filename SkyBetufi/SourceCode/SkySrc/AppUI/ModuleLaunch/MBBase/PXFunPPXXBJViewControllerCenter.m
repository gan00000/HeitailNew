...
@implementation PXFunPPXXBJViewControllerCenter
+ (PXFunPPXXBJMainViewController *)mainViewController {
    
    if ([MMTodayHTUserManager manager].mainTabBarController) {
        return [MMTodayHTUserManager manager].mainTabBarController;
    }
    ...
    if ([topWindow.rootViewController isKindOfClass:[PXFunPPXXBJMainViewController class]]) {
        return (PXFunPPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
+ (UIViewController *)currentViewController {
    ...
    if ([result isKindOfClass:[PXFunPPXXBJMainViewController class]]) {
        UIViewController *tVc = [(PXFunPPXXBJMainViewController *)result selectedViewController];
