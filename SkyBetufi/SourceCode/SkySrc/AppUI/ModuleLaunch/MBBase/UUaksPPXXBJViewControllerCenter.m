...
@implementation UUaksPPXXBJViewControllerCenter
+ (BlysaPPXXBJMainViewController *)mainViewController {
    
    if ([NSNiceHTUserManager manager].mainTabBarController) {
        return [NSNiceHTUserManager manager].mainTabBarController;
    }
    ...
    if ([topWindow.rootViewController isKindOfClass:[BlysaPPXXBJMainViewController class]]) {
        return (BlysaPPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
+ (UIViewController *)currentViewController {
    ...
    if ([result isKindOfClass:[BlysaPPXXBJMainViewController class]]) {
        UIViewController *tVc = [(BlysaPPXXBJMainViewController *)result selectedViewController];
