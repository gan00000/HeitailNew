...
+ (GlodBulePPXXBJMainViewController *)mainViewController {
    ...
    if ([topWindow.rootViewController isKindOfClass:[GlodBulePPXXBJMainViewController class]]) {
        return (GlodBulePPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
+ (UIViewController *)currentViewController {
    ...
    if ([result isKindOfClass:[GlodBulePPXXBJMainViewController class]]) {
        UIViewController *tVc = [(GlodBulePPXXBJMainViewController *)result selectedViewController];
