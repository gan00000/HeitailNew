...
@implementation CfipyPPXXBJViewControllerCenter
+ (CfipyPPXXBJMainViewController *)mainViewController {
    
    if ([TuTuosHTUserManager manager].mainTabBarController) {
        return [TuTuosHTUserManager manager].mainTabBarController;
    }
    ...
    if ([topWindow.rootViewController isKindOfClass:[CfipyPPXXBJMainViewController class]]) {
        return (CfipyPPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
+ (UIViewController *)currentViewController {
    ...
    if ([result isKindOfClass:[CfipyPPXXBJMainViewController class]]) {
        UIViewController *tVc = [(CfipyPPXXBJMainViewController *)result selectedViewController];
