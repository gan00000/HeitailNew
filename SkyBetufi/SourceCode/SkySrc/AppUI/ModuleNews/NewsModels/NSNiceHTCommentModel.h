...
@interface NSNiceHTCommentModel : NSObject
...
@property (nonatomic, strong) NSArray<TuTuosHTUserInfoModel *> *like;
@property (nonatomic, assign) BOOL my_like;
@property (nonatomic, assign) NSInteger total_reply;
@property (nonatomic, strong) NSArray<NSNiceHTCommentModel *> *reply;
@property (nonatomic, strong) TuTuosHTUserInfoModel *userModel;
