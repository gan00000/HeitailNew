...
@interface CfipyHTNewsModel : NSObject
...
@property (nonatomic, strong) FFlaliHTUserInfoModel *userInfo;
...
@property (nonatomic, strong)WSKggHTNewsAuthor *author;
@property (nonatomic, strong)NSArray<WSKggHTCommentModel *> *hottest_comment;

@property (nonatomic, strong) PLMediaInfo *plMediaInfo;

@property (nonatomic, strong) NSArray<CfipyHTNewsDetailModel *> *mHTNewsDetailModels;
