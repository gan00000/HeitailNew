...
@interface HourseHTCommentModel : NSObject
...
@property (nonatomic, strong) NSArray<GGCatHTUserInfoModel *> *like;
@property (nonatomic, assign) BOOL my_like;
@property (nonatomic, assign) NSInteger total_reply;
@property (nonatomic, strong) NSArray<HourseHTCommentModel *> *reply;
@property (nonatomic, strong) GGCatHTUserInfoModel *userModel;
