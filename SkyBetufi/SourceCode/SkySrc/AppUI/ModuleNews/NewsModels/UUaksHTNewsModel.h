...
@interface UUaksHTNewsModel : NSObject
...
@property (nonatomic, strong) TuTuosHTUserInfoModel *userInfo;
...
@property (nonatomic, strong)YeYeeHTNewsAuthor *author;
@property (nonatomic, strong)NSArray<NSNiceHTCommentModel *> *hottest_comment;

@property (nonatomic, strong) PLMediaInfo *plMediaInfo;

@property (nonatomic, strong) NSArray<FFlaliHTNewsDetailModel *> *mHTNewsDetailModels;
