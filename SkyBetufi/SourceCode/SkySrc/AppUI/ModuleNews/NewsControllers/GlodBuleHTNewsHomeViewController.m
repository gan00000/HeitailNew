...
//        }
    ...
    [GlodBuleHTNewsBannerRequest taorequestWithSuccessBlock:^(NSArray<GlodBuleHTNewsModel *> *bannerList) {
...
- (void)loadNextPage {
    self.newsRequestDone = NO;
    kWeakSelf
    [self.request taoloadNextPageWithSuccessBlock:^(NSArray<GlodBuleHTNewsModel *> *newsList) {
//        weakSelf.newsList = newsList;
         weakSelf.newsList = [weakSelf dataWithAd:newsList];
        weakSelf.newsRequestDone = YES;
        [weakSelf refreshUI];
