...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        GlodBuleHTNewsHomeViewController *ewVc = [GlodBuleHTNewsHomeViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        GlodBuleHTFilmHomeViewController *zoneVc = [GlodBuleHTFilmHomeViewController taoviewController];
        vc = zoneVc;
    }
