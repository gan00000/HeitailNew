...
@interface BlysaHTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        KSasxHTNewsHomeViewController *ewVc = [KSasxHTNewsHomeViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        CfipyHTFilmHomeViewController *zoneVc = [CfipyHTFilmHomeViewController taoviewController];
        vc = zoneVc;
    }
