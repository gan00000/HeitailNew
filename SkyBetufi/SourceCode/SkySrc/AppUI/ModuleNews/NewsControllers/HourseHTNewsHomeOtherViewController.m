...
@interface HourseHTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        NDeskHTNewsHomeViewController *ewVc = [NDeskHTNewsHomeViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        RRDogHTFilmHomeViewController *zoneVc = [RRDogHTFilmHomeViewController taoviewController];
        vc = zoneVc;
    }
