...
@interface NSNiceHTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
@end
@implementation NSNiceHTNewsHomeOtherViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        BlysaHTNewsHomeViewController *ewVc = [BlysaHTNewsHomeViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        TuTuosHTFilmHomeViewController *zoneVc = [TuTuosHTFilmHomeViewController taoviewController];
        vc = zoneVc;
    }
