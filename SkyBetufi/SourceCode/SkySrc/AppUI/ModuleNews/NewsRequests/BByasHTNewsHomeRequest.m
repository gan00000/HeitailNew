...
@interface BByasHTNewsHomeRequest ()
@property (nonatomic, strong) NSMutableArray *newsList;
@property (nonatomic, assign) NSInteger page;
@end
@implementation BByasHTNewsHomeRequest
...
+(void)taorequestHighLightWithGameId:(NSString *)gameId successBlock:(void(^)(NSArray<UUaksHTNewsModel *> *newsList))successBlock
    ...
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_GET_highlights params:params successBlock:^(id responseData) {
