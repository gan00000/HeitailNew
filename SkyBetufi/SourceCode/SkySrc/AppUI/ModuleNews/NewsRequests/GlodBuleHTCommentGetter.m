...
- (void)loadHotCommentsWithCompleteBlock:(dispatch_block_t)block {
    [GlodBuleHTNewsAdditionRequest taorequestHotCommentWithOffset:self.hotOffset newsId:self.post_id successBlock:^(NSArray<GlodBuleHTCommentModel *> * _Nonnull commentList, NSInteger pages) {
        if (self.hotOffset == 0) {
...
- (void)loadNormalCommentsWithCompleteBlock:(dispatch_block_t)block {
    [GlodBuleHTNewsAdditionRequest taorequestNormalCommentWithOffset:self.normalOffset newsId:self.post_id successBlock:^(NSArray<GlodBuleHTCommentModel *> * _Nonnull commentList, NSInteger pages) {
