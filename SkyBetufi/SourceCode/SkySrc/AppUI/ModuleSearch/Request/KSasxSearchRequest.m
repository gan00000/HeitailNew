...
@interface KSasxSearchRequest ()
@property (nonatomic, strong) NSMutableArray *newsList;
@property (nonatomic, assign) NSInteger page;
@property (nonatomic, copy) NSString *xkey;
@end

@implementation KSasxSearchRequest
...
- (void)requestWithKey:(NSString *)key successBlock:(void(^)(NSArray<CfipyHTNewsModel *> *newsList))successBlock
    ...
    [NSNiceBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_SEARCH params:params successBlock:^(id responseData) {
...
//                 errorBlock:(BJServiceErrorBlock)errorBlock {
//
//    [NSNiceBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_SEARCH params:@{@"search":key, @"page": [NSString stringWithFormat:@"%d",xPage], @"count":@20} successBlock:^(id responseData) {
//
