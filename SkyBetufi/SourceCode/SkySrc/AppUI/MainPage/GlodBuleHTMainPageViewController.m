#import "GlodBuleHTMainPageViewController.h"
...
@interface GlodBuleHTMainPageViewController ()<UITableViewDelegate, UITableViewDataSource, PlayerTableViewCellDelegate>
...
@end
@implementation GlodBuleHTMainPageViewController
