...
@interface GlodBuleHTRankRightCell ()
...
@end
@implementation GlodBuleHTRankRightCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taorefreshWithRankModel:(GlodBuleHTRankModel *)rankModel row:(NSInteger)row {
    self.winLabel.text = rankModel.win;
    self.loseLabel.text = rankModel.loss;
    self.winRateLabel.text = rankModel.winRate;
    self.homeLabel.text = rankModel.gamesBack;
    self.awayLabel.text = rankModel.streakDescription;
