...
#import "CCCaseHTRankRightCell.h"
@interface PXFunHTRankHomeCell () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UILabel *titleLabel;
@property (weak, nonatomic) IBOutlet UITableView *leftTableView;
//@property (weak, nonatomic) IBOutlet UIScrollView *scrollContentView;
//@property (nonatomic, strong) UITableView *rightTableView;
@property (nonatomic, weak) NSArray<PXFunHTRankModel *> *rankList;
@end
@implementation PXFunHTRankHomeCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taosetupWithTitle:(NSString *)title rankList:(NSArray<PXFunHTRankModel *> *)rankList {
...
- (void)setupLeftTableView {
    ...
    [self.leftTableView registerNib:[UINib nibWithNibName:NSStringFromClass([MMTodayHTRankLeftCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([MMTodayHTRankLeftCell class])];
}
/**
- (void)setupRightTableView {
    ...
    [self.rightTableView registerNib:[UINib nibWithNibName:NSStringFromClass([CCCaseHTRankRightCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([CCCaseHTRankRightCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PXFunHTRankModel *model = self.rankList[indexPath.row];
    if (tableView == self.leftTableView) {
        MMTodayHTRankLeftCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([MMTodayHTRankLeftCell class])];
        [cell taorefreshWithRankModel:model row:indexPath.row];
        return cell;
    }
    CCCaseHTRankRightCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([CCCaseHTRankRightCell class])];
    [cell taorefreshWithRankModel:model row:indexPath.row];
    return cell;
}
