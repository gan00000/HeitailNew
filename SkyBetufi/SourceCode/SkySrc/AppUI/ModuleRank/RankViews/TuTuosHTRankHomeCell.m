#import "TuTuosHTRankHomeCell.h"
#import "BlysaHTRankLeftCell.h"
#import "KSasxHTRankRightCell.h"
@interface TuTuosHTRankHomeCell () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UILabel *titleLabel;
@property (weak, nonatomic) IBOutlet UITableView *leftTableView;
//@property (weak, nonatomic) IBOutlet UIScrollView *scrollContentView;
//@property (nonatomic, strong) UITableView *rightTableView;
@property (nonatomic, weak) NSArray<FFlaliHTRankModel *> *rankList;
@end
@implementation TuTuosHTRankHomeCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)setupLeftTableView {
    ...
    [self.leftTableView registerNib:[UINib nibWithNibName:NSStringFromClass([BlysaHTRankLeftCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([BlysaHTRankLeftCell class])];
}
/**
- (void)setupRightTableView {
    ...
    [self.rightTableView registerNib:[UINib nibWithNibName:NSStringFromClass([KSasxHTRankRightCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([KSasxHTRankRightCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FFlaliHTRankModel *model = self.rankList[indexPath.row];
    if (tableView == self.leftTableView) {
        BlysaHTRankLeftCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([BlysaHTRankLeftCell class])];
        [cell taorefreshWithRankModel:model row:indexPath.row];
        return cell;
    }
    KSasxHTRankRightCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([KSasxHTRankRightCell class])];
    [cell taorefreshWithRankModel:model row:indexPath.row];
    return cell;
}
