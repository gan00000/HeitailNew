...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        GlodBuleHTRankEastWestViewController *ewVc = [GlodBuleHTRankEastWestViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        GlodBuleHTRankZoneViewController *zoneVc = [GlodBuleHTRankZoneViewController taoviewController];
        vc = zoneVc;
    }
