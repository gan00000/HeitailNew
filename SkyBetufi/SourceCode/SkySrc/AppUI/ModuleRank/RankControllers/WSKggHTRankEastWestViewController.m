#import "WSKggHTRankEastWestViewController.h"
#import "BByasHTRankEastWestRequest.h"
#import "TuTuosHTRankHomeCell.h"
@interface WSKggHTRankEastWestViewController () <UITableViewDelegate, UITableViewDataSource>
...
#pragma mark - private
- (void)loadData {
    [BByasHTRankEastWestRequest taorequestWithSuccessBlock:^(BByasHTRankEastWestModel *eastWestModel) {
