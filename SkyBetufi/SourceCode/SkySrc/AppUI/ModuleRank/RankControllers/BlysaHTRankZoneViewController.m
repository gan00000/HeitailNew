#import "BlysaHTRankZoneViewController.h"
#import "YeYeeHTRankZoneRequest.h"
#import "TuTuosHTRankHomeCell.h"
@interface BlysaHTRankZoneViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) FFlaliHTRankZoneModel *zoneModel;
@property (nonatomic, strong) YeYeeBJError *error;
@end
@implementation BlysaHTRankZoneViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TuTuosHTRankHomeCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([TuTuosHTRankHomeCell class])];
...
#pragma mark - private
- (void)loadData {
    [YeYeeHTRankZoneRequest taorequestWithSuccessBlock:^(FFlaliHTRankZoneModel *zoneModel) {
...
- (void)setupViews {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([TuTuosHTRankHomeCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([TuTuosHTRankHomeCell class])];
    kWeakSelf
