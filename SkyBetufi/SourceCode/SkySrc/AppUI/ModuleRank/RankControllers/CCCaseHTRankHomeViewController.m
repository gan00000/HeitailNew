...
@interface CCCaseHTRankHomeViewController () <UIScrollViewDelegate>
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        GGCatHTRankEastWestViewController *ewVc = [GGCatHTRankEastWestViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        HourseHTRankZoneViewController *zoneVc = [HourseHTRankZoneViewController taoviewController];
        vc = zoneVc;
    }
