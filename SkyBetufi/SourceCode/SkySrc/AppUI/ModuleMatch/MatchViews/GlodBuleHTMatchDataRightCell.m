...
@interface GlodBuleHTMatchDataRightCell ()
...
@end
@implementation GlodBuleHTMatchDataRightCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taorefreshWithModel:(GlodBuleHTMatchDetailsModel *)model row:(NSInteger)row {
