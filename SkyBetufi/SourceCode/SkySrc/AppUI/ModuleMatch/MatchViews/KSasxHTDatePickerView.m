...
@interface KSasxHTDatePickerView ()
...
@end
@implementation KSasxHTDatePickerView
- (instancetype)init {
...
+ (void)taoshowWithWithDate:(NSDate *)date didTapEnterBlock:(HTDatePickerEnterBlock)enterBlock {
    KSasxHTDatePickerView *datePicker = [[KSasxHTDatePickerView alloc] init];
