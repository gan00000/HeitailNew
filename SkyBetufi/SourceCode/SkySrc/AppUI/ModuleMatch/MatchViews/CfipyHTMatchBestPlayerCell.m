...
@interface CfipyHTMatchBestPlayerCell ()
...
@property (nonatomic,strong)NSNiceBarChartUtil *ptsBarChartUtil;
@property (nonatomic,strong)NSNiceBarChartUtil *rebBarChartUtil;
@property (nonatomic,strong)NSNiceBarChartUtil *astBarChartUtil;


@end
@implementation CfipyHTMatchBestPlayerCell
- (void)awakeFromNib {
    [super awakeFromNib];
    self.selectionStyle = UITableViewCellSelectionStyleNone;
    
    self.ptsBarChartUtil = [[NSNiceBarChartUtil alloc] initWithChart:self.ptsBarChart];
    self.rebBarChartUtil = [[NSNiceBarChartUtil alloc] initWithChart:self.rebBarChart];
    self.astBarChartUtil = [[NSNiceBarChartUtil alloc] initWithChart:self.astBarChart];
}
