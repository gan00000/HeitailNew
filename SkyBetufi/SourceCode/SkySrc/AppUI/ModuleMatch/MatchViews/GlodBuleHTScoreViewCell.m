...
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    _mLineChartUtil = [[GlodBuleLineChartUtil alloc]init];
...
- (void)setMatchSummaryModel:(GlodBuleHTMatchSummaryModel *)summaryModel liveFeedModel:(NSArray<GlodBuleHTMatchLiveFeedModel *> *)liveFeedModel
{
    ...
    NSArray<GlodBuleHTMatchLiveFeedModel *> *c_liveFeedModel = [liveFeedModel copy];
...
//        BJLog(@"quarter = %ld",quarter);
    ...
    GlodBuleHTMatchLiveFeedModel *last_feedMode = c_liveFeedModel.lastObject;
