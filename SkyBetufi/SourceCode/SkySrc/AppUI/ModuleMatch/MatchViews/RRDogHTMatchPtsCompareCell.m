...
@interface RRDogHTMatchPtsCompareCell ()
...
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *ptsCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *rebCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *astCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *blkCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *stlCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *fgmadeCompareView;

@property (weak, nonatomic) IBOutlet RRDogHTCompareView *fg3madeCompareView;
@property (weak, nonatomic) IBOutlet RRDogHTCompareView *ftCompareView;

@end
@implementation RRDogHTMatchPtsCompareCell
- (void)awakeFromNib {
    [super awakeFromNib];
