...
@interface YYPackageHTMatchBestPlayerCell ()
...
@property (nonatomic,strong)KMonkeyBarChartUtil *ptsBarChartUtil;
@property (nonatomic,strong)KMonkeyBarChartUtil *rebBarChartUtil;
@property (nonatomic,strong)KMonkeyBarChartUtil *astBarChartUtil;


@end
@implementation YYPackageHTMatchBestPlayerCell
- (void)awakeFromNib {
    [super awakeFromNib];
    self.selectionStyle = UITableViewCellSelectionStyleNone;
    
    self.ptsBarChartUtil = [[KMonkeyBarChartUtil alloc] initWithChart:self.ptsBarChart];
    self.rebBarChartUtil = [[KMonkeyBarChartUtil alloc] initWithChart:self.rebBarChart];
    self.astBarChartUtil = [[KMonkeyBarChartUtil alloc] initWithChart:self.astBarChart];
}
