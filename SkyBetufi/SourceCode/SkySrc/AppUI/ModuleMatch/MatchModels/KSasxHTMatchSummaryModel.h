...
@interface KSasxHTMatchSummaryModel : NSObject
...
@property (nonatomic, weak) UUaksHTMatchDetailsModel *home_team_pts_most;
@property (nonatomic, weak) UUaksHTMatchDetailsModel *away_team_pts_most;
@property (nonatomic, weak) UUaksHTMatchDetailsModel *home_team_ast_most;
@property (nonatomic, weak) UUaksHTMatchDetailsModel *away_team_ast_most;
@property (nonatomic, weak) UUaksHTMatchDetailsModel *home_team_reb_most;
@property (nonatomic, weak) UUaksHTMatchDetailsModel *away_team_reb_most;
