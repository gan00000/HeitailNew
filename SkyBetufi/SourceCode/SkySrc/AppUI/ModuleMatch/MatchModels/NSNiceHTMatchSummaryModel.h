...
@interface NSNiceHTMatchSummaryModel : NSObject
...
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *home_team_pts_most;
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *away_team_pts_most;
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *home_team_ast_most;
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *away_team_ast_most;
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *home_team_reb_most;
@property (nonatomic, weak) TuTuosHTMatchDetailsModel *away_team_reb_most;
