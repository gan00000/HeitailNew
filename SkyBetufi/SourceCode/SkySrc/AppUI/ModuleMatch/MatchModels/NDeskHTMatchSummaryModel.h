...
@interface NDeskHTMatchSummaryModel : NSObject
...
@property (nonatomic, weak) SundayHTMatchDetailsModel *home_team_pts_most;
@property (nonatomic, weak) SundayHTMatchDetailsModel *away_team_pts_most;
@property (nonatomic, weak) SundayHTMatchDetailsModel *home_team_ast_most;
@property (nonatomic, weak) SundayHTMatchDetailsModel *away_team_ast_most;
@property (nonatomic, weak) SundayHTMatchDetailsModel *home_team_reb_most;
@property (nonatomic, weak) SundayHTMatchDetailsModel *away_team_reb_most;
