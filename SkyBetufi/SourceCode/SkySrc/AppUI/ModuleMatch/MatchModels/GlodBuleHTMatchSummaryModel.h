...
@interface GlodBuleHTMatchSummaryModel : NSObject
...
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *home_team_pts_most;
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *away_team_pts_most;
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *home_team_ast_most;
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *away_team_ast_most;
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *home_team_reb_most;
@property (nonatomic, weak) GlodBuleHTMatchDetailsModel *away_team_reb_most;
