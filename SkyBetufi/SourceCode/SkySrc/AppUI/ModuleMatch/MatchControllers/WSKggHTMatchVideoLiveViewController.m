...
@interface WSKggHTMatchVideoLiveViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation WSKggHTMatchVideoLiveViewController
...
-(void)taoRequestPostidByGameid:(dispatch_block_t)block{
    ...
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_LIVE_POST_GAME params:@{@"game_id":self.game_id}
