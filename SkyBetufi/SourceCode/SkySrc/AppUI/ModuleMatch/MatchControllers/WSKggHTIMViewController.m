...
@interface WSKggHTIMViewController () <UITableViewDelegate, UITableViewDataSource, SRWebSocketDelegate>
...
@property (nonatomic) TuTuosHTMatchHomeModel *matchModel;
...
@implementation WSKggHTIMViewController
...
- (void)setupViews {
    ...
    //    kWeakSelf
    //    self.imContentTableView.mj_header = [YeYeeMJRefreshGenerator bj_headerWithRefreshingBlock:^{
...
-(void)sendLoginData
{
    ...
    req.token = TuTuosHTUserManager.tao_userToken;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FFlaliHTUserInfoModel *userInfoModel = [TuTuosHTUserManager tao_userInfo];
