...
@interface MMoogHTIMViewController () <UITableViewDelegate, UITableViewDataSource, SRWebSocketDelegate>
...
@property (nonatomic) FFlaliHTMatchHomeModel *matchModel;
...
- (void)setupViews {
    ...
    [self.imContentTableView registerNib:[UINib nibWithNibName:NSStringFromClass([YeYeeHTChatContentCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([YeYeeHTChatContentCell class])];
    
    [self.imContentTableView registerNib:[UINib nibWithNibName:NSStringFromClass([BlysaHTChatSelfContentCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([BlysaHTChatSelfContentCell class])];
    
    //    kWeakSelf
    //    self.imContentTableView.mj_header = [BlysaMJRefreshGenerator bj_headerWithRefreshingBlock:^{
...
-(void)sendLoginData
{
    ...
    req.token = NSNiceHTUserManager.tao_userToken;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TuTuosHTUserInfoModel *userInfoModel = [NSNiceHTUserManager tao_userInfo];
    
    if (chatContent.fromUserId == [userInfoModel.user_id longLongValue]) {
        
        YeYeeHTChatContentCell *cell = (YeYeeHTChatContentCell *)[tableView dequeueReusableCellWithIdentifier:NSStringFromClass([BlysaHTChatSelfContentCell class])];
    ...
    YeYeeHTChatContentCell *cell = (YeYeeHTChatContentCell *)[tableView dequeueReusableCellWithIdentifier:@"YeYeeHTChatContentCell"];
    //[cell setChaMsg:[NSString stringWithFormat:@"%@ - %@", chatContent.content, chatContent.fromUserName]];
    cell.chatContentLabel.text = chatContent.content;
    cell.userNameLabel.text = chatContent.fromUserName;
    [cell.userImage sd_setImageWithURL:[NSURL URLWithString:chatContent.fromUserImg] placeholderImage:HT_DEFAULT_TEAM_LOGO];
