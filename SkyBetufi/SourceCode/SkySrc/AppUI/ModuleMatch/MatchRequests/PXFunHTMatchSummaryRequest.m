...
@implementation PXFunHTMatchSummaryRequest
+ (void)taorequestSummaryWithGameId:(NSString *)game_id
    ...
    [PXFunBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_SUMMARY params:@{@"game_id":game_id} successBlock:^(id responseData) {
        NDeskHTMatchSummaryModel *summaryModel = [NDeskHTMatchSummaryModel yy_modelWithJSON:[responseData[@"match_summary"] firstObject]];
        PXFunHTMatchCompareModel *compareModel = [[PXFunHTMatchCompareModel alloc] init];
        ...
        NSArray *detailList = [NSArray yy_modelArrayWithClass:[SundayHTMatchDetailsModel class] json:responseData[@"matchDetails"]];
        ...
        SundayHTMatchDetailsModel *home_team_pts_most = nil;
        SundayHTMatchDetailsModel *away_team_pts_most = nil;
        SundayHTMatchDetailsModel *home_team_ast_most = nil;
        SundayHTMatchDetailsModel *away_team_ast_most = nil;
        SundayHTMatchDetailsModel *home_team_reb_most = nil;
        SundayHTMatchDetailsModel *away_team_reb_most = nil;
        for (SundayHTMatchDetailsModel *model in detailList) {
...
+ (void)requestLivePostWithGameId:(NSString *)game_id
                successBlock:(void(^)(HourseHTMacthLivePostModel * livePost))successBlock
                  errorBlock:(BJServiceErrorBlock)errorBlock {
    [PXFunBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_LIVE_POST params:@{@"game_id":game_id} successBlock:^(id responseData) {
        
        HourseHTMacthLivePostModel *livePost = [HourseHTMacthLivePostModel yy_modelWithJSON:[responseData[@"result"] firstObject]];
        if (successBlock) {
...
+ (void)requestLikeMatchTeamWithGameId:(NSString *)game_id
               ...
               successBlock:(void(^)(NDeskHTLikeTeamModel * m))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [PXFunBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_LIKE_MATCH_TEAM params:@{@"game_id":game_id, @"type": type} successBlock:^(id responseData) {
...
+ (void)requestPlayerInfo:(NSString *)game_id
               ...
               successBlock:(void(^)(NSArray<SundayHTMatchDetailsModel *> * model))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [PXFunBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_PLAYER_INFO params:@{@"game_id":game_id, @"team_id": team_id, @"player_id": player_id} successBlock:^(id responseData) {
       
        NSArray *models = [NSArray yy_modelArrayWithClass:[SundayHTMatchDetailsModel class] json:responseData[@"matchDetails"]];
       if (successBlock) {
           successBlock(models);
       }
                 ...
                 errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    [PXFunBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_GET_SHOOT_POINT params:@{@"game_id":game_id, @"home_away": home_away, @"player_id": player_id, @"quarter":quarter} successBlock:^(id responseData) {

        NSArray *models = [NSArray yy_modelArrayWithClass:[HourseHotShootPointModel class] json:responseData[@"result"]];
            if (successBlock) {
                successBlock(models);
            }
