...
+ (void)taorequestSummaryWithGameId:(NSString *)game_id
    ...
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_SUMMARY params:@{@"game_id":game_id} successBlock:^(id responseData) {
        NSNiceHTMatchSummaryModel *summaryModel = [NSNiceHTMatchSummaryModel yy_modelWithJSON:[responseData[@"match_summary"] firstObject]];
        WSKggHTMatchCompareModel *compareModel = [[WSKggHTMatchCompareModel alloc] init];
        ...
        NSArray *detailList = [NSArray yy_modelArrayWithClass:[TuTuosHTMatchDetailsModel class] json:responseData[@"matchDetails"]];
        ...
        TuTuosHTMatchDetailsModel *home_team_pts_most = nil;
        TuTuosHTMatchDetailsModel *away_team_pts_most = nil;
        TuTuosHTMatchDetailsModel *home_team_ast_most = nil;
        TuTuosHTMatchDetailsModel *away_team_ast_most = nil;
        TuTuosHTMatchDetailsModel *home_team_reb_most = nil;
        TuTuosHTMatchDetailsModel *away_team_reb_most = nil;
        for (TuTuosHTMatchDetailsModel *model in detailList) {
...
+ (void)requestLivePostWithGameId:(NSString *)game_id
                successBlock:(void(^)(NSNiceHTMacthLivePostModel * livePost))successBlock
                  errorBlock:(BJServiceErrorBlock)errorBlock {
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_LIVE_POST params:@{@"game_id":game_id} successBlock:^(id responseData) {
        
        NSNiceHTMacthLivePostModel *livePost = [NSNiceHTMacthLivePostModel yy_modelWithJSON:[responseData[@"result"] firstObject]];
        if (successBlock) {
...
+ (void)requestLikeMatchTeamWithGameId:(NSString *)game_id
               ...
               successBlock:(void(^)(YeYeeHTLikeTeamModel * m))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_LIKE_MATCH_TEAM params:@{@"game_id":game_id, @"type": type} successBlock:^(id responseData) {
...
+ (void)requestPlayerInfo:(NSString *)game_id
               ...
               successBlock:(void(^)(NSArray<TuTuosHTMatchDetailsModel *> * model))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_PLAYER_INFO params:@{@"game_id":game_id, @"team_id": team_id, @"player_id": player_id} successBlock:^(id responseData) {
       
        NSArray *models = [NSArray yy_modelArrayWithClass:[TuTuosHTMatchDetailsModel class] json:responseData[@"matchDetails"]];
       if (successBlock) {
           successBlock(models);
       }
                 ...
                 errorBlock:(BJServiceErrorBlock)errorBlock
{
    ...
    [BlysaBJHTTPServiceEngine tao_getRequestWithFunctionPath:API_MATCH_GET_SHOOT_POINT params:@{@"game_id":game_id, @"home_away": home_away, @"player_id": player_id, @"quarter":quarter} successBlock:^(id responseData) {

        NSArray *models = [NSArray yy_modelArrayWithClass:[BByasHotShootPointModel class] json:responseData[@"result"]];
            if (successBlock) {
                successBlock(models);
            }
