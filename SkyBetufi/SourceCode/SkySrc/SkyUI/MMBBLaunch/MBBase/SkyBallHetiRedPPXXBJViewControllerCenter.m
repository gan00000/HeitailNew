...
@implementation SkyBallHetiRedPPXXBJViewControllerCenter
+ (SkyBallHetiRedPPXXBJMainViewController *)mainViewController {
    ...
    if ([topWindow.rootViewController isKindOfClass:[SkyBallHetiRedPPXXBJMainViewController class]]) {
        return (SkyBallHetiRedPPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
+ (UIViewController *)currentViewController {
    ...
    if ([result isKindOfClass:[SkyBallHetiRedPPXXBJMainViewController class]]) {
        UIViewController *tVc = [(SkyBallHetiRedPPXXBJMainViewController *)result selectedViewController];
