...
+ (XRRFATKPPXXBJMainViewController *)mainViewController {
    ...
    if ([topWindow.rootViewController isKindOfClass:[XRRFATKPPXXBJMainViewController class]]) {
        return (XRRFATKPPXXBJMainViewController *)topWindow.rootViewController;
    }
    return nil;
}
