...
- (NSArray<NSString *> *)waterSkytabBarTitles {
    BJLog(@"GlodBulePPXXBJMainViewController waterSkytabBarTitles");
...
- (NSArray<UIViewController *> *)waterSkytabBarControllers {
    if (!self.vc1) {
        self.vc1 = [GlodBuleHTMatchHomeViewController waterSkyviewController];
//        self.vc1.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    if (!self.vc2) {
        self.vc2 = [GlodBuleHTNewsHomeViewController waterSkyviewController];
//        self.vc2.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    if (!self.vc3) {
        self.vc3 = [GlodBuleHTFilmHomeViewController waterSkyviewController];
//        self.vc3.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    if (!self.vc4) {
        self.vc4 = [GlodBuleHTDataHomeViewController waterSkyviewController];
//        self.vc4.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    if (!self.vc5) {
        self.vc5 = [GlodBuleHTRankHomeViewController waterSkyviewController];
//        self.vc5.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    if (!self.vc6) {
        self.vc6 = [GlodBuleHTTabBarHomeViewController waterSkyviewController];
