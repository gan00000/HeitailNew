...
+ (void)waterSkydoLoginRequestWithAccessToken:(NSString *)accessToken
    ...
    param[@"device_token"] = [GlodBuleHTUserManager waterSky_deviceToken];
    param[@"device_type"] = @(1);
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_LOGIN params:param successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyrequestUserInfoWithSuccessBlock:(void(^)(NSDictionary *userInfo))successBlock
                              failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_USER_INFO params:nil successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyupdateUserInfoWithEmail:(NSString *)email
    ...
    param[@"file"] = file;
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_UPDATE params:param successBlock:^(id responseData) {
        if (successBlock) {
            successBlock(responseData[@"result"]);
        }
    } errorBlock:failBlock];
}
+ (void)waterSkyrequestCollectionListWithOffset:(NSInteger)offset successBlock:(void(^)(NSArray <GlodBuleHTNewsModel *> *newsList, NSInteger pages))successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_SAVE_LIST params:@{@"offset": @(offset)} successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyaddCollectionWithNewsId:(NSString *)news_id successBlock:(dispatch_block_t)successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_SAVE_ADD params:@{@"post_id": news_id} successBlock:^(id responseData) {
        if (successBlock) {
            successBlock();
        }
    } errorBlock:failBlock];
...
+ (void)waterSkydeleteCollectionWithNewsId:(NSString *)news_id successBlock:(dispatch_block_t)successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_UNSAVE params:@{@"post_id": news_id} successBlock:^(id responseData) {
        if (successBlock) {
            successBlock();
        }
    } errorBlock:failBlock];
...
+ (void)waterSkyrequestHistoryWithOffset:(NSInteger)offset
                    successBlock:(HTMyCommentBlock)successBlock
                       failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_HISTORY_LIST params:@{@"offset": @(offset)} successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyaddHistoryWithNewsId:(NSString *)news_id successBlock:(dispatch_block_t)successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_HISTORY_ADD params:@{@"post_id": news_id} successBlock:^(id responseData) {
        if (successBlock) {
            successBlock();
        }
    } errorBlock:failBlock];
}
+ (void)waterSkyrequestMyCommentWithOffset:(NSInteger)offset successBlock:(void(^)(NSArray <GlodBuleHTNewsModel *> *newsList, NSInteger pages))successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_MY_COMMENT params:@{@"offset": @(offset)} successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyrequestMyLikeWithOffset:(NSInteger)offset successBlock:(void(^)(NSArray <GlodBuleHTNewsModel *> *newsList, NSInteger pages))successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_MY_LIKE params:@{@"offset": @(offset)} successBlock:^(id responseData) {
        if (successBlock) {
            NSArray *newsList = [NSArray yy_modelArrayWithClass:[GlodBuleHTNewsModel class] json:responseData[@"savedposts"][@"comments"]];
            NSInteger pages = [(NSNumber *)responseData[@"savedposts"][@"pages"] integerValue];
            successBlock(newsList, pages);
...
+ (void)waterSkyrequestUnReadMessageCountWithSuccessBlock:(void(^)(NSInteger count))successBlock failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_MESSAGE_COUNT params:nil successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkyrequestMyMessageWithOffset:(NSInteger)offset
                      successBlock:(void(^)(NSArray <GlodBuleHTMyMessageModel *> *messageList, NSInteger pages))successBlock
                         failBlock:(BJServiceErrorBlock)failBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_MESSAGE_LIST params:@{@"offset": @(offset)} successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)waterSkylikePostWithPostId:(NSString *)post_id comment_id:(NSString *)comment_id like:(BOOL)like successBlock:(dispatch_block_t)successBlock failBlock:(BJServiceErrorBlock)failBlock {
    ...
    params[@"like"] = @(like);
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_LIKE_ADD params:params successBlock:^(id responseData) {
        if (successBlock) {
            successBlock();
        }
    } errorBlock:failBlock];
...
+ (void)waterSkypostCommentWithComment_txt:(NSString *)comment_txt post_id:(NSString *)post_id reply_comment_id:(NSString *)reply_comment_id successBlock:(dispatch_block_t)successBlock failBlock:(BJServiceErrorBlock)failBlock {
    ...
    [GlodBuleBJHTTPServiceEngine waterSky_postRequestWithFunctionPath:API_USER_POST_COMMENT params:params successBlock:^(id responseData) {
        if (successBlock) {
            successBlock();
        }
    } errorBlock:failBlock];
