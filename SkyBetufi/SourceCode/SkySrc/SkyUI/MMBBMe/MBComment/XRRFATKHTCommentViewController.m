//
//  XRRFATKHTCommentViewController.m
//  HeiteBasketball
//
...
@interface XRRFATKHTCommentViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation XRRFATKHTCommentViewController

+ (instancetype)skargviewController {
    return [[XRRFATKHTCommentViewController alloc] init];
}
...
- (void)loadData {
    [XRRFATKHTUserRequest skargrequestMyCommentWithOffset:self.offset successBlock:^(NSArray<XRRFATKHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
