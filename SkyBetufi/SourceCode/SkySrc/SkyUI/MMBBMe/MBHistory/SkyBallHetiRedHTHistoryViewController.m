...
@interface SkyBallHetiRedHTHistoryViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<SkyBallHetiRedHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation SkyBallHetiRedHTHistoryViewController
+ (instancetype)waterSkyviewController {
    return [[SkyBallHetiRedHTHistoryViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"瀏覽歷史";
...
- (void)loadData {
    [SkyBallHetiRedHTUserRequest waterSkyrequestHistoryWithOffset:self.offset successBlock:^(NSArray<SkyBallHetiRedHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
