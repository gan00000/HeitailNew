...
@interface GlodBuleHTHistoryViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<GlodBuleHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation GlodBuleHTHistoryViewController
+ (instancetype)waterSkyviewController {
    return [[GlodBuleHTHistoryViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"瀏覽歷史";
...
- (void)loadData {
    [GlodBuleHTUserRequest waterSkyrequestHistoryWithOffset:self.offset successBlock:^(NSArray<GlodBuleHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
