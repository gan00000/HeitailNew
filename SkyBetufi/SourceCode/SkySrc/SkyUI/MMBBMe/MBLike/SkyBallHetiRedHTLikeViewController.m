...
@interface SkyBallHetiRedHTLikeViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<SkyBallHetiRedHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation SkyBallHetiRedHTLikeViewController
+ (instancetype)waterSkyviewController {
    return [[SkyBallHetiRedHTLikeViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的點讚";
...
- (void)loadData {
    [SkyBallHetiRedHTUserRequest waterSkyrequestMyLikeWithOffset:self.offset successBlock:^(NSArray<SkyBallHetiRedHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
