...
@interface GlodBuleHTLikeViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<GlodBuleHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation GlodBuleHTLikeViewController
+ (instancetype)waterSkyviewController {
    return [[GlodBuleHTLikeViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的點讚";
...
- (void)loadData {
    [GlodBuleHTUserRequest waterSkyrequestMyLikeWithOffset:self.offset successBlock:^(NSArray<GlodBuleHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
