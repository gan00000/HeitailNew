...
//        self.avatarImageView.image = [GlodBuleHTUserManager waterSky_userInfo].avatar;
        [self.avatarImageView th_setImageWithURL:[GlodBuleHTUserManager waterSky_userInfo].user_img placeholderImage:HT_DEFAULT_AVATAR_LOGO];
        self.userNameLabel.text = [GlodBuleHTUserManager waterSky_userInfo].display_name;
    } else {
