...
@interface SkyBallHetiRedHTMeHomeViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, assign) NSInteger messageCount;
@end
@implementation SkyBallHetiRedHTMeHomeViewController
+ (instancetype)waterSkyviewController {
    return [[SkyBallHetiRedHTMeHomeViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的";
