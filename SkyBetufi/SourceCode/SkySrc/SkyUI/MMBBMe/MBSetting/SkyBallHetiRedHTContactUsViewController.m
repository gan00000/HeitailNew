#import "SkyBallHetiRedHTContactUsViewController.h"
@interface SkyBallHetiRedHTContactUsViewController ()
@property (weak, nonatomic) IBOutlet UILabel *emailLabel;
@property (weak, nonatomic) IBOutlet UILabel *fansLabel;
@end
@implementation SkyBallHetiRedHTContactUsViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"聯繫我們";
}
