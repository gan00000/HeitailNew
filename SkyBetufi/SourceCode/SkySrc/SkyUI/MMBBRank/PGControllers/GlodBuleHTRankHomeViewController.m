...
#import "GlodBuleHTRankZoneViewController.h"
#import <HMSegmentedControl/HMSegmentedControl.h>
@interface GlodBuleHTRankHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation GlodBuleHTRankHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        GlodBuleHTRankEastWestViewController *ewVc = [GlodBuleHTRankEastWestViewController waterSkyviewController];
        vc = ewVc;
    } else if (index == 1) {
        GlodBuleHTRankZoneViewController *zoneVc = [GlodBuleHTRankZoneViewController waterSkyviewController];
        vc = zoneVc;
    }
