...
@interface SkyBallHetiRedHTRankHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation SkyBallHetiRedHTRankHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        SkyBallHetiRedHTRankEastWestViewController *ewVc = [SkyBallHetiRedHTRankEastWestViewController waterSkyviewController];
        vc = ewVc;
    } else if (index == 1) {
        SkyBallHetiRedHTRankZoneViewController *zoneVc = [SkyBallHetiRedHTRankZoneViewController waterSkyviewController];
        vc = zoneVc;
    }
