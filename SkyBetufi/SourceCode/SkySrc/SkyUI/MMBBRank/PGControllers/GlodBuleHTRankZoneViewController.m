...
@interface GlodBuleHTRankZoneViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) GlodBuleHTRankZoneModel *zoneModel;
@property (nonatomic, strong) GlodBuleBJError *error;
@end
@implementation GlodBuleHTRankZoneViewController
...
#pragma mark - private
- (void)loadData {
    [GlodBuleHTRankZoneRequest waterSkyrequestWithSuccessBlock:^(GlodBuleHTRankZoneModel *zoneModel) {
