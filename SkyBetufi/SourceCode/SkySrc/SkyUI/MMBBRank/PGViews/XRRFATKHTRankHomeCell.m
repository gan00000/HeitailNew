...
#import "XRRFATKHTRankRightCell.h"

@interface XRRFATKHTRankHomeCell () <UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, weak) NSArray<XRRFATKHTRankModel *> *rankList;

@end

@implementation XRRFATKHTRankHomeCell
...
- (void)setupLeftTableView {
    ...
    [self.leftTableView registerNib:[UINib nibWithNibName:NSStringFromClass([XRRFATKHTRankLeftCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([XRRFATKHTRankLeftCell class])];
}
...
- (void)setupRightTableView {
    ...
    [self.rightTableView registerNib:[UINib nibWithNibName:NSStringFromClass([XRRFATKHTRankRightCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([XRRFATKHTRankRightCell class])];
