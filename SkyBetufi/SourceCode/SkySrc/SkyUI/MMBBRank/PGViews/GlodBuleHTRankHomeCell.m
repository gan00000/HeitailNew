...
#import "GlodBuleHTRankLeftCell.h"
#import "GlodBuleHTRankRightCell.h"
@interface GlodBuleHTRankHomeCell () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UILabel *titleLabel;
@property (weak, nonatomic) IBOutlet UITableView *leftTableView;
//@property (weak, nonatomic) IBOutlet UIScrollView *scrollContentView;
//@property (nonatomic, strong) UITableView *rightTableView;
@property (nonatomic, weak) NSArray<GlodBuleHTRankModel *> *rankList;
@end
@implementation GlodBuleHTRankHomeCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)waterSkysetupWithTitle:(NSString *)title rankList:(NSArray<GlodBuleHTRankModel *> *)rankList {
...
- (void)setupLeftTableView {
    ...
    [self.leftTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GlodBuleHTRankLeftCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([GlodBuleHTRankLeftCell class])];
}
/**
- (void)setupRightTableView {
    ...
    [self.rightTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GlodBuleHTRankRightCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([GlodBuleHTRankRightCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    GlodBuleHTRankModel *model = self.rankList[indexPath.row];
    if (tableView == self.leftTableView) {
        GlodBuleHTRankLeftCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([GlodBuleHTRankLeftCell class])];
        [cell waterSkyrefreshWithRankModel:model row:indexPath.row];
        return cell;
    }
    GlodBuleHTRankRightCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([GlodBuleHTRankRightCell class])];
    [cell waterSkyrefreshWithRankModel:model row:indexPath.row];
    return cell;
}
