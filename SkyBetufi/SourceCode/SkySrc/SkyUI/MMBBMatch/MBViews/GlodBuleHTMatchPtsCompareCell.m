...
@interface GlodBuleHTMatchPtsCompareCell ()
...
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *ptsCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *rebCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *astCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *blkCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *stlCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *fgmadeCompareView;

@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *fg3madeCompareView;
@property (weak, nonatomic) IBOutlet GlodBuleHTCompareView *ftCompareView;

@end
@implementation GlodBuleHTMatchPtsCompareCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)waterSkysetupWithMatchSummaryModel:(GlodBuleHTMatchSummaryModel *)summaryModel {
