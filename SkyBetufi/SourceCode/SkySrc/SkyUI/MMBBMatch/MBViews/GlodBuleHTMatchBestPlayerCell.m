...
#import "GlodBuleBarChartUtil.h"

@interface GlodBuleHTMatchBestPlayerCell ()
...
@property (nonatomic,strong)GlodBuleBarChartUtil *ptsBarChartUtil;
@property (nonatomic,strong)GlodBuleBarChartUtil *rebBarChartUtil;
@property (nonatomic,strong)GlodBuleBarChartUtil *astBarChartUtil;


@end
@implementation GlodBuleHTMatchBestPlayerCell
- (void)awakeFromNib {
    [super awakeFromNib];
    self.selectionStyle = UITableViewCellSelectionStyleNone;
    
    self.ptsBarChartUtil = [[GlodBuleBarChartUtil alloc] initWithChart:self.ptsBarChart];
    self.rebBarChartUtil = [[GlodBuleBarChartUtil alloc] initWithChart:self.rebBarChart];
    self.astBarChartUtil = [[GlodBuleBarChartUtil alloc] initWithChart:self.astBarChart];
}
