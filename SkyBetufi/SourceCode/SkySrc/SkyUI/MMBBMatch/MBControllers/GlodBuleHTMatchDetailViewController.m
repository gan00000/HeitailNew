...
//    }];
    ...
    if ([GlodBuleHTUserManager waterSky_isUserLogin]) {
        token = [GlodBuleHTUserManager waterSky_userToken];
    }
...
- (void)loadData {
    ...
    self.error = nil;
    [GlodBuleHTMatchLiveFeedRequest waterSkyrequestLiveFeedWithGameId:self.matchModel.game_id successBlock:^(NSArray<GlodBuleHTMatchLiveFeedModel *> *feedList) {
    ...
    [GlodBuleHTMatchSummaryRequest waterSkyrequestSummaryWithGameId:self.matchModel.game_id successBlock:^(GlodBuleHTMatchSummaryModel *summaryModel, GlodBuleHTMatchCompareModel *compareModel) {
...
//             if (index == 0) {
//
//                 GlodBuleHTMatchVideoLiveViewController *detailVc =  self.loadedControllersArray[index];//[GlodBuleHTMatchVideoLiveViewController waterSkyviewController];
...
//
//             //视频直播
//             GlodBuleHTMatchVideoLiveViewController *detailVc = [GlodBuleHTMatchVideoLiveViewController waterSkyviewController];
//             detailVc.game_id = self.matchModel.game_id;
//             vc = detailVc;
//
//
...
//         } else
             ...
             GlodBuleHTMatchWordLiveViewController *wordVc = [GlodBuleHTMatchWordLiveViewController waterSkyviewController];
             ...
             GlodBuleHTMatchCompareViewController *compareVc = [GlodBuleHTMatchCompareViewController waterSkyviewController];
             [compareVc waterSkyrefreshWithMatchSummaryModel:self.matchSummaryModel liveFeedModel:self.liveFeedList];
             ...
             self.imVc = [GlodBuleHTIMViewController waterSkyviewController];
...
//             };
             ...
             GlodBuleHTMatchDashboardViewController *dashboardVc = [GlodBuleHTMatchDashboardViewController waterSkyviewController];
