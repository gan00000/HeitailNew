...
- (void)webSocketDidOpen:(SRWebSocket *)webSocket{
    ...
    if (self.socket != nil) {
        ...
        if (_socket.readyState == SR_OPEN) {
            ...
            //用户登录
            if (GlodBuleHTUserManager.waterSky_userToken && ![@"" isEqualToString:GlodBuleHTUserManager.waterSky_userToken]) {
                [self sendLoginData];
            }
...
-(void)sendLoginData
{
    ...
    req.token = GlodBuleHTUserManager.waterSky_userToken;
