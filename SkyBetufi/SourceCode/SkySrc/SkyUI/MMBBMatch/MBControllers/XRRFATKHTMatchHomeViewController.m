...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    XRRFATKHTMatchHomeGroupHeaderView *view = (XRRFATKHTMatchHomeGroupHeaderView *)[tableView dequeueReusableHeaderFooterViewWithIdentifier:@"XRRFATKHTMatchHomeGroupHeaderView"];
    XRRFATKHTMatchHomeGroupModel *groupModel = self.matchList[section];
    ...
    [XRRFATKHTMatchHomeRequest skargrequestWithStartDate:[self ymdWithDate:self.startDate]
                                ...
                                successBlock:^(NSArray<XRRFATKHTMatchHomeGroupModel *> *matchList) {
                                    ...
                                    if (matchList.count == 0) {
                                        ...
                                        for (XRRFATKHTMatchHomeGroupModel *groupModel in matchList) {
                                            for (XRRFATKHTMatchHomeModel *model in groupModel.matchList) {
