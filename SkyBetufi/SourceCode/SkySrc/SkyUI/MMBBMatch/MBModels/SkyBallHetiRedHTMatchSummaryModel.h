...
@interface SkyBallHetiRedHTMatchSummaryModel : NSObject
...
@property (nonatomic, weak) SkyBallHetiRedHTMatchDetailsModel *home_team_pts_most;
@property (nonatomic, weak) SkyBallHetiRedHTMatchDetailsModel *away_team_pts_most;
@property (nonatomic, weak) SkyBallHetiRedHTMatchDetailsModel *home_team_ast_most;
