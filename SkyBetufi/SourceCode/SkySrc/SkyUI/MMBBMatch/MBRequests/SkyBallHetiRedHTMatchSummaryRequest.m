...
+ (void)waterSkyrequestSummaryWithGameId:(NSString *)game_id
    ...
    [SkyBallHetiRedBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_MATCH_SUMMARY params:@{@"game_id":game_id} successBlock:^(id responseData) {
        SkyBallHetiRedHTMatchSummaryModel *summaryModel = [SkyBallHetiRedHTMatchSummaryModel yy_modelWithJSON:[responseData[@"match_summary"] firstObject]];
        SkyBallHetiRedHTMatchCompareModel *compareModel = [[SkyBallHetiRedHTMatchCompareModel alloc] init];
        ...
        NSArray *detailList = [NSArray yy_modelArrayWithClass:[SkyBallHetiRedHTMatchDetailsModel class] json:responseData[@"matchDetails"]];
        ...
        SkyBallHetiRedHTMatchDetailsModel *home_team_pts_most = nil;
        SkyBallHetiRedHTMatchDetailsModel *away_team_pts_most = nil;
        SkyBallHetiRedHTMatchDetailsModel *home_team_ast_most = nil;
        SkyBallHetiRedHTMatchDetailsModel *away_team_ast_most = nil;
        SkyBallHetiRedHTMatchDetailsModel *home_team_reb_most = nil;
        SkyBallHetiRedHTMatchDetailsModel *away_team_reb_most = nil;
        for (SkyBallHetiRedHTMatchDetailsModel *model in detailList) {
