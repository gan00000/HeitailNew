...
+ (void)waterSkyrequestSummaryWithGameId:(NSString *)game_id
    ...
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_MATCH_SUMMARY params:@{@"game_id":game_id} successBlock:^(id responseData) {
...
+ (void)requestLivePostWithGameId:(NSString *)game_id
                successBlock:(void(^)(GlodBuleHTMacthLivePostModel * livePost))successBlock
                  errorBlock:(BJServiceErrorBlock)errorBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_MATCH_LIVE_POST params:@{@"game_id":game_id} successBlock:^(id responseData) {
...
+ (void)requestLikeMatchTeamWithGameId:(NSString *)game_id
               ...
               successBlock:(void(^)(GlodBuleHTLikeTeamModel * m))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_MATCH_LIKE_MATCH_TEAM params:@{@"game_id":game_id, @"type": type} successBlock:^(id responseData) {
...
+ (void)requestPlayerInfo:(NSString *)game_id
               ...
               successBlock:(void(^)(NSArray<GlodBuleHTMatchDetailsModel *> * model))successBlock
                 errorBlock:(BJServiceErrorBlock)errorBlock {
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_MATCH_PLAYER_INFO params:@{@"game_id":game_id, @"team_id": team_id, @"player_id": player_id} successBlock:^(id responseData) {
