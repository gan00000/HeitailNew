...
+ (void)skargrequestWithStartDate:(NSString *)startDate
    ...
    [XRRFATKBJHTTPServiceEngine getRequestWithFunctionPath:API_MATCH_HOME params:params successBlock:^(id responseData) {
...
+ (void)skargrequestMatchProgressWithGameId:(NSString *)game_id
    ...
    [XRRFATKBJHTTPServiceEngine getRequestWithFunctionPath:API_MATCH_PROGRESS params:params successBlock:^(id responseData) {
        if (successBlock) {
