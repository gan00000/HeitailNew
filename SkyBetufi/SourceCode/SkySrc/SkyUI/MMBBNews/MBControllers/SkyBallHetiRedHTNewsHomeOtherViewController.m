...
@interface SkyBallHetiRedHTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
@end
@implementation SkyBallHetiRedHTNewsHomeOtherViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        SkyBallHetiRedHTNewsHomeViewController *ewVc = [SkyBallHetiRedHTNewsHomeViewController waterSkyviewController];
        vc = ewVc;
    } else if (index == 1) {
        SkyBallHetiRedHTFilmHomeViewController *zoneVc = [SkyBallHetiRedHTFilmHomeViewController waterSkyviewController];
        vc = zoneVc;
    }
