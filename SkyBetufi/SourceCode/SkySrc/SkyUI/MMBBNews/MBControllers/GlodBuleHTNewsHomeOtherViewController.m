...
@interface GlodBuleHTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
@end
@implementation GlodBuleHTNewsHomeOtherViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        GlodBuleHTNewsHomeViewController *ewVc = [GlodBuleHTNewsHomeViewController waterSkyviewController];
        vc = ewVc;
    } else if (index == 1) {
        GlodBuleHTFilmHomeViewController *zoneVc = [GlodBuleHTFilmHomeViewController waterSkyviewController];
        vc = zoneVc;
    }
