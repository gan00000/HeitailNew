...
@interface XRRFATKHTNewsHomeBannerCell () <UIScrollViewDelegate>
...
@implementation XRRFATKHTNewsHomeBannerCell
...
- (void)setupWithNewsModels:(NSArray *)bannerList {
    ...
    if (self.bannerList.count > 0) {
        ...
        if (self.bannerList.count > 1) {
            ...
            XRRFATKHTNewsModel *lastBanner = [self.bannerList lastObject];
            ...
            XRRFATKHTNewsModel *firstBanner = [self.bannerList firstObject];
...
- (void)onBannerImageTapped:(UITapGestureRecognizer *)tap {
    ...
    XRRFATKHTNewsModel *banner = self.bannerList[tapImageView.tag];
...
- (void)p_setupTitle {
    ...
    XRRFATKHTNewsModel *currentModel = self.bannerList[index];
