...
+ (void)waterSkyrequestAllTeamRankDataWithType:(NSString *)type
    ...
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_TEAM_RANK_ALL params:params successBlock:^(id responseData) {
        if (successBlock) {
...
+ (void)requestAllPlayerRankDataWithType:(NSString *)type
    ...
    [GlodBuleBJHTTPServiceEngine waterSky_getRequestWithFunctionPath:API_PLAYER_RANK_ALL params:params successBlock:^(id responseData) {
        if (successBlock) {
