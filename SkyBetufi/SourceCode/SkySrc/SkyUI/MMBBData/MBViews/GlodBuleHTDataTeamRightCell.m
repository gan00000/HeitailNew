...
@interface GlodBuleHTDataTeamRightCell ()
...
@end
@implementation GlodBuleHTDataTeamRightCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)waterSkyrefreshWithTeamModel:(GlodBuleHTDataTeamRankModel *)teamModel row:(NSInteger)row {
