...
@interface GlodBuleHTDataHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation GlodBuleHTDataHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        GlodBuleHTRankEastWestViewController *vc = [GlodBuleHTRankEastWestViewController waterSkyviewController];
        //vc.type = index + 1;
    ...
    GlodBuleHTDataHomeSubViewController *vc = [GlodBuleHTDataHomeSubViewController waterSkyviewController];
    if (index == 0) {
        vc.type = 1;//球员1
    } else if(index == 2){
         vc.type = 2;//球队2
