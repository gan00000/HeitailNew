...
@interface YeYeeDRDeleteAlertView ()
...
@end
@implementation YeYeeDRDeleteAlertView
- (instancetype)init {
...
+ (void)showDeleteAlertViewWithComplete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    [YeYeeDRDeleteAlertView showWithTitle:@"删除" message:@"确定是否删除？" content:nil complete:complete];
}
...
+ (void)showWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content complete:(DRNoteTagDeleteAlertViewCompleteBlock)complete {
    YeYeeDRDeleteAlertView *alertView = [[YeYeeDRDeleteAlertView alloc] init];
