...
- (void)setResult:(id)result {
    ...
    [[WSKggTZImageManager manager] getAssetsFromFetchResult:result allowPickingVideo:allowPickingVideo allowPickingImage:allowPickingImage completion:^(NSArray<UUaksTZAssetModel *> *models) {
        _models = models;
        if (_selectedModels) {
