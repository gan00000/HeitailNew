#import "BByasLxGridViewFlowLayout.h"
#import "NSNiceDRPhotoKeyboardCell.h"
...
@interface BByasLxGridViewFlowLayout () <UIGestureRecognizerDelegate>
...
@end
@implementation BByasLxGridViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            NSNiceDRPhotoKeyboardCell *sourceCell = (NSNiceDRPhotoKeyboardCell *)sourceCollectionViewCell;
