...
@interface NSNiceTZGifPhotoPreviewController () {
    UIView *_toolBar;
...
@end
@implementation NSNiceTZGifPhotoPreviewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)configBottomToolBar {
    ...
    [[WSKggTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
