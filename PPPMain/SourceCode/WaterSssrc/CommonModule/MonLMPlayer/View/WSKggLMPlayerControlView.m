...
#import "WSKggLMPlayerControlView.h"
#import "TuTuosMMMaterialDesignSpinner.h"
#import <Masonry.h>
...
@interface WSKggLMPlayerControlView ()
/** 加载loading */
@property (nonatomic, strong) TuTuosMMMaterialDesignSpinner *activity;
/** 快进快退View */
...
@implementation WSKggLMPlayerControlView

+ (instancetype)playerControlViewWithStatusModel:(MMoogLMPlayerStatusModel *)playerStatusModel {
    WSKggLMPlayerControlView *instance = [[self alloc] init];
...
- (UUaksLMPortraitControlView *)portraitControlView {
    if (!_portraitControlView) {
        _portraitControlView = [[UUaksLMPortraitControlView alloc] init];
    }
    return _portraitControlView;
}

- (YeYeeLMLandScapeControlView *)landScapeControlView {
    if (!_landScapeControlView) {
        _landScapeControlView = [[YeYeeLMLandScapeControlView alloc] init];
    }
    return _landScapeControlView;
}

- (TuTuosMMMaterialDesignSpinner *)activity {
    if (!_activity) {
        _activity = [[TuTuosMMMaterialDesignSpinner alloc] init];
