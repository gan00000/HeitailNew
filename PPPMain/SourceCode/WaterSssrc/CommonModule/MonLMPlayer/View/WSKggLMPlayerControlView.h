...
#import "YeYeeLMLandScapeControlView.h"
#import "BByasLMCoverControlView.h"
#import "TuTuosLMLoadingView.h"
...
@interface WSKggLMPlayerControlView : UIView
...
/** 横屏控制层的View */
@property (nonatomic, strong) YeYeeLMLandScapeControlView *landScapeControlView;
/** 上次播放至xx秒(默认0) */
