...
@interface NSNiceLMPlayerManager ()
...
@implementation NSNiceLMPlayerManager

+ (instancetype)playerManagerWithDelegate:(id<LMPlayerManagerDelegate>)delegate playerStatusModel:(MMoogLMPlayerStatusModel *)playerStatusModel {
    
    NSNiceLMPlayerManager *playerMgr = [[NSNiceLMPlayerManager alloc] init];
