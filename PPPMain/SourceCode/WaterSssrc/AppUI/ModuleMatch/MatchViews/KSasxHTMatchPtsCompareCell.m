...
@interface KSasxHTMatchPtsCompareCell ()
...
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *ptsCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *rebCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *astCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *blkCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *stlCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *fgmadeCompareView;

@property (weak, nonatomic) IBOutlet BlysaHTCompareView *fg3madeCompareView;
@property (weak, nonatomic) IBOutlet BlysaHTCompareView *ftCompareView;

@end
@implementation KSasxHTMatchPtsCompareCell
- (void)awakeFromNib {
    [super awakeFromNib];
...
- (void)taosetupWithMatchSummaryModel:(KSasxHTMatchSummaryModel *)summaryModel {
