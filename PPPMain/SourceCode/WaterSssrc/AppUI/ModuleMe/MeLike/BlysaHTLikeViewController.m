...
@interface BlysaHTLikeViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<CfipyHTNewsModel *> *dataSource;
@property (nonatomic, assign) NSInteger offset;
@end
@implementation BlysaHTLikeViewController
+ (instancetype)taoviewController {
    return [[BlysaHTLikeViewController alloc] init];
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的點讚";
...
- (void)loadData {
    [NSNiceHTUserRequest taorequestMyLikeWithOffset:self.offset successBlock:^(NSArray<CfipyHTNewsModel *> * _Nonnull newsList, NSInteger pages) {
