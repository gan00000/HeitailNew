...
#import "FFlaliHTRankZoneViewController.h"
#import <HMSegmentedControl/HMSegmentedControl.h>
@interface WSKggHTRankHomeViewController () <UIScrollViewDelegate>
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        KSasxHTRankEastWestViewController *ewVc = [KSasxHTRankEastWestViewController taoviewController];
        vc = ewVc;
    } else if (index == 1) {
        FFlaliHTRankZoneViewController *zoneVc = [FFlaliHTRankZoneViewController taoviewController];
        vc = zoneVc;
    }
