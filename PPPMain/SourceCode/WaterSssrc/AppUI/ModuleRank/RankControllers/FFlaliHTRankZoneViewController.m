...
@interface FFlaliHTRankZoneViewController () <UITableViewDataSource, UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) MMoogHTRankZoneModel *zoneModel;
...
#pragma mark - private
- (void)loadData {
    [TuTuosHTRankZoneRequest taorequestWithSuccessBlock:^(MMoogHTRankZoneModel *zoneModel) {
