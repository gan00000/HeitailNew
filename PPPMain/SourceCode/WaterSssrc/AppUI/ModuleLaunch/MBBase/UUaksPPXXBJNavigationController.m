...
@interface UUaksPPXXBJNavigationController ()
@end
@implementation UUaksPPXXBJNavigationController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (NSArray<Class> *)taoviewControllersNotHideTabBar {
    return @[[FFlaliHTNewMatchHomeViewController class],
             ...
             [BByasPPXXBJLaunchViewController class],
             [NSNiceHTMainPageViewController class],
             [UUaksMainLanmuViewController class],
             
             [NSNiceHTTabBarHomeViewController class]];
}
